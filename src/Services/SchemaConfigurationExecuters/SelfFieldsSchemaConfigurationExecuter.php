...
{
    /**
     * @var \GraphQLAPI\GraphQLAPI\Services\Blocks\SchemaConfigSelfFieldsBlock|null
     */
    private $schemaConfigSelfFieldsBlock;

    /**
     * @param \GraphQLAPI\GraphQLAPI\Services\Blocks\SchemaConfigSelfFieldsBlock $schemaConfigSelfFieldsBlock
     */
    final public function setSchemaConfigSelfFieldsBlock($schemaConfigSelfFieldsBlock): void
    {
    ...
    final protected function getSchemaConfigSelfFieldsBlock(): SchemaConfigSelfFieldsBlock
    {
        ...
        return $this->schemaConfigSelfFieldsBlock = $this->schemaConfigSelfFieldsBlock ?? $this->instanceManager->getInstance(SchemaConfigSelfFieldsBlock::class);
    }
