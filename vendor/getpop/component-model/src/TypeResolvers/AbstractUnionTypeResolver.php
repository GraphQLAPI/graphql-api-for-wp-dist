...
abstract class AbstractUnionTypeResolver extends AbstractTypeResolver implements UnionTypeResolverInterface
{
    ...
    protected function getUnresolvedResultItemIDError($resultItemID)
    {
        ...
        return new Error(
            ...
            sprintf($translationAPI->__('Either the DataLoader can\'t load data, or no TypeResolver resolves, object with ID \'%s\'', 'pop-component-model'), $resultItemID)
        );
    }
    ...
    protected function getUnresolvedResultItemError($resultItem)
    {
        ...
        return new Error(
            ...
            sprintf($translationAPI->__('No TypeResolver resolves object \'%s\'', 'pop-component-model'), json_encode($resultItem))
        );
    }
