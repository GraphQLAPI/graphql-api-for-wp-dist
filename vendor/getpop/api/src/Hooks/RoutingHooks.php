...
class RoutingHooks extends \PoP\Hooks\AbstractHookSet
{
    ...
    {
        if (!\PoP\API\ComponentConfiguration::overrideRequestURI()) {
            return $route;
        }
        $cmsengineapi = \PoP\Engine\FunctionAPIFactory::getInstance();
        $homeURL = $cmsengineapi->getHomeURL();
        $currentURL = \PoP\ComponentModel\Misc\RequestUtils::getCurrentUrl();
