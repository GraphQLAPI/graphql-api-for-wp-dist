...
abstract class AbstractFieldDirectiveResolver extends \PoP\ComponentModel\DirectiveResolvers\AbstractDirectiveResolver implements \PoP\ComponentModel\DirectiveResolvers\FieldDirectiveResolverInterface
{
    ...
    /**
     * @param \PoP\ComponentModel\Schema\SchemaCastingServiceInterface $schemaCastingService
     */
    public final function setSchemaCastingService($schemaCastingService) : void
    {
    ...
    protected final function getSchemaCastingService() : SchemaCastingServiceInterface
    {
        ...
        return $this->schemaCastingService = $this->schemaCastingService ?? $this->instanceManager->getInstance(SchemaCastingServiceInterface::class);
    }
    /**
     * @return string[]
     */
     ...
     */
    public function createDirectiveDataAccessor($directiveArgs) : DirectiveDataAccessorInterface
    {
     ...
     */
    protected function setHasValidationErrors($hasValidationErrors) : void
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function getDirectiveArgs($relationalTypeResolver, $fields, $engineIterationFeedbackStore) : ?array
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function getResolvedDirectiveArgs($relationalTypeResolver, $idFieldSet, $engineIterationFeedbackStore) : ?array
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function getResolvedDirectiveArgsForObjectAndField($relationalTypeResolver, $field, $id, $engineIterationFeedbackStore) : ?array
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function validateDirectiveArgs($directiveArgs, $relationalTypeResolver, $fields, $engineIterationFeedbackStore) : void
    {
        /** @var array<string,mixed> */
        $directiveArgsSchemaDefinition = $this->getDirectiveArgumentsSchemaDefinition($relationalTypeResolver);
        /**
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    protected final function getDirectiveArgumentNameDefaultValues($relationalTypeResolver) : ?array
    {
        $directiveArgsSchemaDefinition = $this->getDirectiveArgumentsSchemaDefinition($relationalTypeResolver);
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    protected final function getDirectiveArgumentsSchemaDefinition($relationalTypeResolver) : array
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    public final function resolveCanProcessField($relationalTypeResolver, $field) : bool
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    protected function resolveCanProcessFieldBasedOnSupportedFieldTypeResolverClasses($objectTypeResolver, $field) : bool
    {
        /**
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    protected function getFieldTypeResolverFromAppStateOrField($objectTypeResolver, $field) : ?ConcreteTypeResolverInterface
    {
     ...
     * @return string[]
     */
    protected function getConcreteTypeResolverNamesOrDescriptions($concreteTypeResolvers) : ?array
    {
     ...
     */
    protected function getSupportedConcreteTypeResolvers($supportedFieldTypeResolverContainerServiceIDs) : ?array
    {
     ...
     * @param array<string|int,EngineIterationFieldSet> $idFieldSet
     */
    protected function hasSomeIDField($idFieldSet) : bool
    {
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    public final function hasDirectiveVersion($relationalTypeResolver) : bool
    {
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    public final function getDirectiveArgsSchemaDefinition($relationalTypeResolver) : array
    {
        // Cache the result
        $cacheKey = \get_class($relationalTypeResolver);
     ...
     * @param string $directiveArgName
     */
    protected function getDirectiveArgExtensionsSchemaDefinition($relationalTypeResolver, $directiveArgName) : array
    {
     ...
     * @param string $directiveArgName
     */
    protected final function getConsolidatedDirectiveArgExtensionsSchemaDefinition($relationalTypeResolver, $directiveArgName) : array
    {
        // Cache the result
        $cacheKey = \get_class($relationalTypeResolver) . '(' . $directiveArgName . ':)';
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function processObjectFailure($relationalTypeResolver, $feedbackItemResolution, $idFieldSetToRemove, &$succeedingPipelineIDFieldSet, $astNode, &$resolvedIDFieldValues, $engineIterationFeedbackStore) : void
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function processSchemaFailure($relationalTypeResolver, $feedbackItemResolution, $idFieldSetToRemove, &$succeedingPipelineIDFieldSet, $astNode, &$resolvedIDFieldValues, $engineIterationFeedbackStore) : void
    {
     ...
     * @param array<string|int,EngineIterationFieldSet> $idFieldSet
     */
    protected function setFieldResponseValueAsNull(&$resolvedIDFieldValues, $idFieldSet) : void
    {
        foreach ($idFieldSet as $id => $fieldSet) {
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    protected function getSchemaDefinitionResolver($relationalTypeResolver) : \PoP\ComponentModel\DirectiveResolvers\SchemaFieldDirectiveResolverInterface
    {
        return $this;
    }
    /**
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    public final function getDirectiveSchemaDefinition($relationalTypeResolver) : array
    {
     ...
     * @param \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface $relationalTypeResolver
     */
    public function getDirectiveExtensionsSchemaDefinition($relationalTypeResolver) : array
    {
        return [
