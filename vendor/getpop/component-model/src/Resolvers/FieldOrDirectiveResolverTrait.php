...
trait FieldOrDirectiveResolverTrait
{
    ...
    protected function maybeValidateNotMissingFieldOrDirectiveArguments(TypeResolverInterface $typeResolver, string $fieldOrDirectiveName, array $fieldOrDirectiveArgs, array $fieldOrDirectiveArgsSchemaDefinition, string $type) : ?string
    {
        if ($mandatoryArgs = SchemaHelpers::getSchemaMandatoryFieldOrDirectiveArgs($fieldOrDirectiveArgsSchemaDefinition)) {
            if ($maybeError = $this->validateNotMissingFieldOrDirectiveArguments(SchemaHelpers::getSchemaFieldArgNames($mandatoryArgs), $fieldOrDirectiveName, $fieldOrDirectiveArgs, $type)) {
                return $maybeError;
            }
        }
        return null;
    ...
    {
        if ($maybeError = $this->validateArrayTypeFieldOrDirectiveArguments($fieldOrDirectiveArgsSchemaDefinition, $fieldOrDirectiveName, $fieldOrDirectiveArgs, $type)) {
            return $maybeError;
        }
        return null;
    }
    protected function validateArrayTypeFieldOrDirectiveArguments(array $fieldOrDirectiveArgsSchemaDefinition, string $fieldOrDirectiveName, array $fieldOrDirectiveArgs, string $type) : ?string
    {
        $translationAPI = TranslationAPIFacade::getInstance();
        $errors = [];
        ...
        for ($i = 0; $i < \count($fieldOrDirectiveArgumentNames); $i++) {
            ...
            if ($fieldOrDirectiveArgumentValue !== null) {
                ...
                $fieldOrDirectiveArgMayBeArray = \in_array($fieldOrDirectiveArgType, [SchemaDefinition::TYPE_INPUT_OBJECT, SchemaDefinition::TYPE_OBJECT, SchemaDefinition::TYPE_MIXED]);
                ...
                if (!$fieldOrDirectiveArgIsArray && \is_array($fieldOrDirectiveArgumentValue)) {
                    $errors[] = \sprintf($translationAPI->__('The value for argument \'%1$s\' in %2$s \'%3$s\' must not be an array', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                } elseif ($fieldOrDirectiveArgIsArray && !\is_array($fieldOrDirectiveArgumentValue)) {
                    $errors[] = \sprintf($translationAPI->__('The value for argument \'%1$s\' in %2$s \'%3$s\' must be an array', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                } elseif ($fieldOrDirectiveArgNonNullArrayItems && \is_array($fieldOrDirectiveArgumentValue) && \array_filter($fieldOrDirectiveArgumentValue, function ($arrayItem) {
                    return $arrayItem === null;
                })) {
                    $errors[] = \sprintf($translationAPI->__('The array for argument \'%1$s\' in %2$s \'%3$s\' cannot have `null` values', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                } elseif (!$fieldOrDirectiveArgIsArrayOfArrays && \is_array($fieldOrDirectiveArgumentValue) && \array_filter($fieldOrDirectiveArgumentValue, function ($arrayItem) {
                    return \is_array($arrayItem);
                })) {
                    $errors[] = \sprintf($translationAPI->__('The array for argument \'%1$s\' in %2$s \'%3$s\' must not contain arrays', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                } elseif ($fieldOrDirectiveArgIsArrayOfArrays && \is_array($fieldOrDirectiveArgumentValue) && \array_filter(
                    ...
                    $errors[] = \sprintf($translationAPI->__('The value for argument \'%1$s\' in %2$s \'%3$s\' must be an array of arrays', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                } elseif ($fieldOrDirectiveArgNonNullArrayOfArraysItems && \is_array($fieldOrDirectiveArgumentValue) && \array_filter($fieldOrDirectiveArgumentValue, function (?array $arrayItem) use($arrayItemItem) {
                    return $arrayItem === null ? \false : \array_filter($arrayItem, function ($arrayItemItem) {
                        return $arrayItemItem === null;
                    }) !== [];
                })) {
                    $errors[] = \sprintf($translationAPI->__('The array of arrays for argument \'%1$s\' in %2$s \'%3$s\' cannot have `null` values', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                }
            }
        }
        if ($errors) {
    ...
    protected function maybeValidateEnumFieldOrDirectiveArguments(TypeResolverInterface $typeResolver, string $fieldOrDirectiveName, array $fieldOrDirectiveArgs, array $fieldOrDirectiveArgsSchemaDefinition, string $type) : ?array
    {
        ...
        if ($enumTypeFieldOrDirectiveArgsSchemaDefinition = SchemaHelpers::getEnumTypeFieldOrDirectiveArgsSchemaDefinition($fieldOrDirectiveArgsSchemaDefinition)) {
            return $this->validateEnumFieldOrDirectiveArguments($enumTypeFieldOrDirectiveArgsSchemaDefinition, $fieldOrDirectiveName, $fieldOrDirectiveArgs, $type);
        }
        return null;
    }
    ...
    protected function doValidateEnumFieldOrDirectiveArguments(array $enumTypeFieldOrDirectiveArgsSchemaDefinition, string $fieldOrDirectiveName, array $fieldOrDirectiveArgs, string $type) : ?array
    {
        ...
        for ($i = 0; $i < \count($fieldOrDirectiveArgumentNames); $i++) {
            ...
            if ($fieldOrDirectiveArgumentValue !== null) {
                ...
                $enumTypeFieldOrDirectiveArgMayBeArray = \in_array($enumTypeFieldOrDirectiveArgType, [SchemaDefinition::TYPE_INPUT_OBJECT, SchemaDefinition::TYPE_OBJECT, SchemaDefinition::TYPE_MIXED]);
                ...
                $enumTypeFieldOrDirectiveArgIsArray = ($enumTypeFieldOrDirectiveArgSchemaDefinition[SchemaDefinition::ARGNAME_IS_ARRAY] ?? \false) || $enumTypeFieldOrDirectiveArgIsArrayOfArrays;
                ...
                if (!$enumTypeFieldOrDirectiveArgMayBeArray) {
                    if (!$enumTypeFieldOrDirectiveArgIsArray && \is_array($fieldOrDirectiveArgumentValue)) {
                        $errors[] = \sprintf($translationAPI->__('The value for argument \'%1$s\' in %2$s \'%3$s\' must not be an array', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                        continue;
                    }
                    if ($enumTypeFieldOrDirectiveArgIsArray && !\is_array($fieldOrDirectiveArgumentValue)) {
                    ...
                    if ($enumTypeFieldOrDirectiveArgIsArray && \is_array($fieldOrDirectiveArgumentValue) && $enumTypeFieldOrDirectiveArgNonNullArrayItems && \array_filter($fieldOrDirectiveArgumentValue, function ($arrayItem) {
                        return $arrayItem === null;
                    })) {
                        $errors[] = \sprintf($translationAPI->__('The array for argument \'%1$s\' in %2$s \'%3$s\' cannot have `null` values', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                        continue;
                    }
                    if (!$enumTypeFieldOrDirectiveArgIsArrayOfArrays && \is_array($fieldOrDirectiveArgumentValue) && \array_filter($fieldOrDirectiveArgumentValue, function ($arrayItem) {
                        return \is_array($arrayItem);
                    })) {
                        $errors[] = \sprintf($translationAPI->__('The array for argument \'%1$s\' in %2$s \'%3$s\' must not contain arrays', 'component-model'), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName);
                        continue;
                    }
                    if ($enumTypeFieldOrDirectiveArgIsArrayOfArrays && \is_array($fieldOrDirectiveArgumentValue) && \array_filter(
                        $fieldOrDirectiveArgumentValue,
                        // `null` could be accepted as an array! (Validation against null comes next)
                        function ($arrayItem) {
                            return !\is_array($arrayItem) && $arrayItem !== null;
                    ...
                    if ($enumTypeFieldOrDirectiveArgIsArrayOfArrays && \is_array($fieldOrDirectiveArgumentValue) && $enumTypeFieldOrDirectiveArgNonNullArrayOfArraysItems && \array_filter($fieldOrDirectiveArgumentValue, function (?array $arrayItem) use($arrayItemItem) {
                        return $arrayItem === null ? \false : \array_filter($arrayItem, function ($arrayItemItem) {
                            return $arrayItemItem === null;
                        }) !== [];
                    })) {
                ...
                $this->doValidateEnumFieldOrDirectiveArgumentsItem($errors, $deprecations, $schemaFieldOrDirectiveArgumentEnumValues, $fieldOrDirectiveArgumentValueEnums, $fieldOrDirectiveArgumentName, $fieldOrDirectiveName, $type);
            }
        }
        // if ($errors) {
        //     return implode($translationAPI->__('. '), $errors);
    ...
    protected function doValidateEnumFieldOrDirectiveArgumentsItem(array &$errors, array &$deprecations, array $schemaFieldOrDirectiveArgumentEnumValues, array $fieldOrDirectiveArgumentValueItems, string $fieldOrDirectiveArgumentName, string $fieldOrDirectiveName, string $type) : void
    {
        $translationAPI = TranslationAPIFacade::getInstance();
        ...
        if ($errorItems) {
            ...
            if (\count($errorItems) === 1) {
                $errors[] = \sprintf($translationAPI->__('Value \'%1$s\' for argument \'%2$s\' in %3$s \'%4$s\' is not allowed (the only allowed values are: \'%5$s\')', 'component-model'), \implode($translationAPI->__('\', \''), $errorItems), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName, \implode($translationAPI->__('\', \''), $fieldOrDirectiveArgumentEnumValues));
            } else {
                $errors[] = \sprintf($translationAPI->__('Values \'%1$s\' for argument \'%2$s\' in %3$s \'%4$s\' are not allowed (the only allowed values are: \'%5$s\')', 'component-model'), \implode($translationAPI->__('\', \''), $errorItems), $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName, \implode($translationAPI->__('\', \''), $fieldOrDirectiveArgumentEnumValues));
            }
        }
        foreach ($deprecationItems as $fieldOrDirectiveArgumentValueItem => $deprecationItemDescription) {
            $deprecations[] = \sprintf($translationAPI->__('Value \'%1$s\' for argument \'%2$s\' in %3$s \'%4$s\' is deprecated: \'%5$s\'', 'component-model'), $fieldOrDirectiveArgumentValueItem, $fieldOrDirectiveArgumentName, $type == \PoP\ComponentModel\Resolvers\ResolverTypes::FIELD ? $translationAPI->__('field', 'component-model') : $translationAPI->__('directive', 'component-model'), $fieldOrDirectiveName, $deprecationItemDescription);
        }
    }
}
