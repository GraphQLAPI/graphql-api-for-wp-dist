...
EOF;
        ...
        return sprintf($blockContentPlaceholder, $this->getBlockClassName(), $values ?
            sprintf('<p><strong>%s</strong></p><ul><li><code>%s</code></li></ul>', $this->getHeader(), implode('</code></li><li><code>', $values)) :
