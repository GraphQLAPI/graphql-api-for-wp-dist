...
class RootPostTagFieldResolver extends AbstractQueryableFieldResolver
{
    ...
    {
        $descriptions = ['postTag' => $this->translationAPI->__('Post tag with a specific ID', 'pop-post-tags'), 'postTags' => $this->translationAPI->__('Post tags', 'pop-post-tags'), 'postTagCount' => $this->translationAPI->__('Number of post tags', 'pop-post-tags'), 'postTagNames' => $this->translationAPI->__('Names of the post tags', 'pop-post-tags')];
    ...
    {
        $types = ['postTag' => SchemaDefinition::TYPE_ID, 'postTags' => SchemaDefinition::TYPE_ID, 'postTagCount' => SchemaDefinition::TYPE_INT, 'postTagNames' => SchemaDefinition::TYPE_STRING];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        ...
        switch ($fieldName) {
            case 'postTag':
                return \array_merge($schemaFieldArgs, [[SchemaDefinition::ARGNAME_NAME => 'id', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ID, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The tag ID', 'pop-post-tags'), SchemaDefinition::ARGNAME_MANDATORY => \true]]);
            case 'postTags':
            case 'postTagCount':
            case 'postTagNames':
    ...
    public function resolveValue(TypeResolverInterface $typeResolver, $resultItem, string $fieldName, array $fieldArgs = [], ?array $variables = null, ?array $expressions = null, array $options = [])
    {
        ...
        switch ($fieldName) {
            ...
            case 'postTagNames':
                ...
                $options = ['return-type' => $fieldName === 'postTags' ? ReturnTypes::IDS : ReturnTypes::NAMES];
