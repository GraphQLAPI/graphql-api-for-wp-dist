...
class Engine extends UpstreamEngine
{
    ...
    protected final function getLooseContractManager() : LooseContractManagerInterface
    {
        ...
        return $this->looseContractManager = $this->looseContractManager ?? $this->instanceManager->getInstance(LooseContractManagerInterface::class);
    }
    /**
    ...
    protected function getHeaders() : array
    {
        ...
        if (App::getModule(CacheControlModule::class)->isEnabled()) {
            if ($cacheControlHeaders = $this->getCacheControlEngine()->getCacheControlHeaders()) {
                $headers = \array_merge($headers, $cacheControlHeaders);
            }
        }
        return $headers;
    }
