...
class PoP_Taxonomies_Posts_Module_Processor_FieldDataloads extends \PoP\API\ModuleProcessors\AbstractRelationalFieldDataloadModuleProcessor
{
    use QueriedDBObjectModuleProcessorTrait;
    public const MODULE_DATALOAD_RELATIONALFIELDS_TAGPOSTLIST = 'dataload-relationalfields-tagpostlist';
    public function getModulesToProcess() : array
    {
        return array([self::class, self::MODULE_DATALOAD_RELATIONALFIELDS_TAGPOSTLIST]);
    }
...
\class_alias('PrefixedByPoP\\PoP_Taxonomies_Posts_Module_Processor_FieldDataloads', 'PoP_Taxonomies_Posts_Module_Processor_FieldDataloads', \false);
