...
class Validation
{
    ...
    {
        return \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->applyFilters('PoP_TaxonomyQuery_Validation:provider-validation-class', null);
    }
    ...
    {
        $this->providerinstall_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'));
    }
    public function providerinitialize_warning()
    {
        $this->providerinitialize_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'));
    }
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomyquery'));
    }
    public function installWarning()
    {
        $this->dependencyInstallationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomyquery'), 'https://github.com/leoloso/PoP');
    }
    public function versionWarning()
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomy Query', 'pop-taxonomyquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Taxonomies', 'pop-taxonomyquery'), 'https://github.com/leoloso/PoP', POP_TAXONOMYQUERY_POP_TAXONOMIES_MIN_VERSION);
    }
