...
abstract class AbstractCustomPostFieldResolver extends AbstractDBDataFieldResolver
{
    ...
    {
        $descriptions = ['update' => $this->translationAPI->__('Update the custom post', 'custompost-mutations')];
        return $descriptions[$fieldName] ?? parent::getSchemaFieldDescription($typeResolver, $fieldName);
    }
    public function getSchemaFieldType(TypeResolverInterface $typeResolver, string $fieldName) : string
    {
        $types = ['update' => SchemaDefinition::TYPE_ID];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        switch ($fieldName) {
            case 'update':
                return SchemaDefinitionHelpers::getCreateUpdateCustomPostSchemaFieldArgs($typeResolver, $fieldName, \false, $this->resolveFieldTypeResolverClass($typeResolver, $fieldName));
        }
