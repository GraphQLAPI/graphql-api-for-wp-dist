...
class MediaFieldResolver extends AbstractDBDataFieldResolver
{
    ...
    {
        $types = ['src' => SchemaDefinition::TYPE_URL, 'width' => SchemaDefinition::TYPE_INT, 'height' => SchemaDefinition::TYPE_INT];
    ...
    {
        $descriptions = ['src' => $this->translationAPI->__('Media element URL source', 'pop-media'), 'width' => $this->translationAPI->__('Media element\'s width', 'pop-media'), 'height' => $this->translationAPI->__('Media element\'s height', 'pop-media')];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        ...
        switch ($fieldName) {
            ...
            case 'height':
                ...
                return \array_merge($schemaFieldArgs, [[SchemaDefinition::ARGNAME_NAME => 'size', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_STRING, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('Size of the image', 'pop-media')], [SchemaDefinition::ARGNAME_NAME => 'device', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ENUM, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('Device where to show the image', 'pop-media'), SchemaDefinition::ARGNAME_ENUM_NAME => $mediaDeviceEnum->getName(), SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($mediaDeviceEnum->getValues())]]);
        }
