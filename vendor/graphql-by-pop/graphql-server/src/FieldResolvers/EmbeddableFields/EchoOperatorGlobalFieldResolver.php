...
class EchoOperatorGlobalFieldResolver extends OperatorGlobalFieldResolver
{
    ...
    {
        $types = ['echoStr' => SchemaDefinition::TYPE_STRING];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        ...
        switch ($fieldName) {
            case 'echoStr':
                return \array_merge($schemaFieldArgs, [[SchemaDefinition::ARGNAME_NAME => 'value', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_STRING, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The input string to be echoed back', 'graphql-api'), SchemaDefinition::ARGNAME_MANDATORY => \true]]);
        }
    ...
    {
        $descriptions = ['echoStr' => $this->translationAPI->__('Repeat back the input string', 'graphql-api')];
