...
{
    /**
     * @var \GraphQLAPI\GraphQLAPI\PluginManagement\MainPluginManager
     */
    protected static $mainPluginManager;
    /**
     * @var \GraphQLAPI\GraphQLAPI\PluginManagement\ExtensionManager
     */
    protected static $extensionManager;

    /**
     * @param \GraphQLAPI\GraphQLAPI\PluginManagement\MainPluginManager|null $mainPluginManager
     * @param \GraphQLAPI\GraphQLAPI\PluginManagement\ExtensionManager|null $extensionManager
     */
    public static function initializePlugin($mainPluginManager = null, $extensionManager = null): void
    {
