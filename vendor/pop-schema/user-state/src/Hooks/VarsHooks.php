...
class VarsHooks extends \PoP\Hooks\AbstractHookSet
{
    protected function init()
    {
        ...
        $this->hooksAPI->addAction(\PoP\Engine\FieldResolvers\OperatorGlobalFieldResolver::HOOK_SAFEVARS, [$this, 'setSafeVars'], 10, 1);
    }
    /**
    ...
    public function addVars(array $vars_in_array) : void
    {
        ...
        \PoPSchema\UserState\State\ApplicationStateUtils::setUserStateVars($vars);
    }
}
