        ...
        switch ($checkpoint[1]) {
            case self::ENABLED_MUTATIONS:
                ...
                if (!$vars['are-mutations-enabled']) {
                    ...
                    $errorMessage = HooksAPIFacade::getInstance()->applyFilters(self::HOOK_MUTATIONS_NOT_SUPPORTED_ERROR_MSG, $translationAPI->__('Mutations cannot be executed', 'component-model'));
                    return new Error(
