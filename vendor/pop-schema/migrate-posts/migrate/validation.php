...
class Validation
{
    ...
    {
        return \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->applyFilters('PoP_Posts_Validation:provider-validation-class', null);
    }
    ...
    {
        $this->providerinstall_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-posts'));
    }
    public function providerinitialize_warning()
    {
        $this->providerinitialize_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-posts'));
    }
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-posts'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-posts'));
    }
    public function installWarning()
    {
        $this->dependencyInstallationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-posts'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-posts'), 'https://github.com/leoloso/PoP');
    }
    public function versionWarning()
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-posts'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-posts'), 'https://github.com/leoloso/PoP', POP_POSTS_POP_ENGINE_MIN_VERSION);
    }
