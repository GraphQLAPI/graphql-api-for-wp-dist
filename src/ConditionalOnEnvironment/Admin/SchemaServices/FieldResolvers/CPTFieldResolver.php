    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName): array
    {
        ...
        switch ($fieldName) {
            ...
            case 'schemaConfigurations':
                $schemaFieldArgs = array_merge($schemaFieldArgs, $this->getFieldArgumentsSchemaDefinitions($typeResolver, $fieldName));
                // Remove the "customPostTypes" field argument
                $schemaFieldArgs = array_filter($schemaFieldArgs, function ($schemaFieldArg) {
