 ...
 */
function str(\PrefixedByPoP\Psr\Http\Message\MessageInterface $message)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\PrefixedByPoP\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\PrefixedByPoP\Psr\Http\Message\MessageInterface $message)
{
    \PrefixedByPoP\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\PrefixedByPoP\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\PrefixedByPoP\Psr\Http\Message\StreamInterface $source, \PrefixedByPoP\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\PrefixedByPoP\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\PrefixedByPoP\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\PrefixedByPoP\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \PrefixedByPoP\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
