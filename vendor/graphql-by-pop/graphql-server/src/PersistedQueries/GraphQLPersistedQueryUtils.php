...
class GraphQLPersistedQueryUtils
{
    public static function addPersistedQuery(string $queryName, string $graphQLQuery, ?string $description = null) : void
    {
        ...
        list($operationType, $fieldQuery) = $graphQLQueryConvertor->convertFromGraphQLToFieldQuery($graphQLQuery);
    ...
    public static function addPersistedFragment(string $fragmentName, string $graphQLFragment, ?string $description = null) : void
    {
        ...
        $graphQLQueryConvertor = \GraphQLByPoP\GraphQLQuery\Facades\GraphQLQueryConvertorFacade::getInstance();
        list($operationType, $fieldQuery) = $graphQLQueryConvertor->convertFromGraphQLToFieldQuery($graphQLFragment);
