...
trait ObjectTypeOrFieldDirectiveResolverTrait
{
     ...
     */
    protected final function getFieldOrDirectiveArgumentNameDefaultValues($fieldOrDirectiveArgsSchemaDefinition) : array
    {
     ...
     * @return array<string,mixed>
     */
    protected final function addDefaultFieldOrDirectiveArguments($fieldOrDirectiveArgs, $argumentNameDefaultValues) : array
    {
