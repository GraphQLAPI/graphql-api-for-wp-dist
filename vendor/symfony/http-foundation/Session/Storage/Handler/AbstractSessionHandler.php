...
abstract class AbstractSessionHandler implements \SessionHandlerInterface, \SessionUpdateTimestampHandlerInterface
{
     ...
     */
    protected abstract function doRead($sessionId) : string;
    /**
     * @param string $sessionId
     * @param string $data
     */
    protected abstract function doWrite($sessionId, $data) : bool;
    /**
     * @param string $sessionId
     */
    protected abstract function doDestroy($sessionId) : bool;
