...
class ASTNodeDuplicatorService implements \PoP\GraphQLParser\AST\ASTNodeDuplicatorServiceInterface
{
     ...
     */
    protected function recursivelyCloneFragment($fragment) : Fragment
    {
     ...
     */
    protected function recursivelyCloneFieldOrFragmentBonds($fieldsOrFragmentBonds) : array
    {
     ...
     */
    protected function cloneRelationalField($relationalField) : RelationalField
    {
     ...
     */
    protected function cloneLeafField($leafField) : LeafField
    {
