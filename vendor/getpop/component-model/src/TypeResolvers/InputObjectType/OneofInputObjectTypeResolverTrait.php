...
trait OneofInputObjectTypeResolverTrait
{
     ...
     */
    protected function validateOneofInputObjectValue($inputValue, $astNode, $objectTypeFieldResolutionFeedbackStore) : void
    {
     ...
     */
    protected function isOneOfInputPropertyNullable($propertyName) : bool
    {
        return \false;
    }
    /**
