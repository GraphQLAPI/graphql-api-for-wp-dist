...
class CustomPostTypeMutationAPI implements CustomPostTypeMutationAPIInterface
{
     ...
     * @return string|int|null|\PoP\ComponentModel\ErrorHandling\Error the ID of the created custom post, or null if there was an error
     */
    ...
    /**
     * @param array<string, mixed> $data
     * @return string|int|null|\PoP\ComponentModel\ErrorHandling\Error the ID of the updated custom post, or null if the post doesn't exist
     */
