    ...
    public function getModelInstanceElementsFromAppState($elements) : array
    {
        ...
        switch ($nature) {
            case RequestNature::CUSTOMPOST:
                ...
                $component_types = (array) App::applyFilters('\\PoP\\ComponentModel\\ModelInstanceProcessor_Utils:components_from_vars:type:single', array(ModelInstanceComponentTypes::SINGLE_CUSTOMPOST));
