...
class ApplicationState
{
    ...
    public static function getVars(): array
    {
        ...
        $outputs = (array) HooksAPIFacade::getInstance()->applyFilters('ApplicationState:outputs', array(
        ...
        $alldataoutputitems = (array) HooksAPIFacade::getInstance()->applyFilters('ApplicationState:dataoutputitems', array(
        ...
        if (!$dataoutputitems) {
            $dataoutputitems = HooksAPIFacade::getInstance()->applyFilters('ApplicationState:default-dataoutputitems', array(
                \GD_URLPARAM_DATAOUTPUTITEMS_META,
                \GD_URLPARAM_DATAOUTPUTITEMS_DATASETMODULESETTINGS,
                \GD_URLPARAM_DATAOUTPUTITEMS_MODULEDATA,
                \GD_URLPARAM_DATAOUTPUTITEMS_DATABASES,
        ...
        $targets = (array) HooksAPIFacade::getInstance()->applyFilters('ApplicationState:targets', array(
            \POP_TARGET_MAIN,
        ));
