...
class RequestHelperService implements \PoP\ComponentModel\HelperServices\RequestHelperServiceInterface
{
    ...
    public function getCurrentURL() : string
    {
        ...
        $remove_params = (array) $this->hooksAPI->applyFilters('RequestUtils:current_url:remove_params', [Params::SETTINGSFORMAT, Params::VERSION, Params::TARGET, ModuleFilterManager::URLPARAM_MODULEFILTER, ModulePaths::URLPARAM_MODULEPATHS, Params::ACTION_PATH, Params::DATA_OUTPUT_ITEMS, Params::DATA_SOURCE, Params::DATAOUTPUTMODE, Params::DATABASESOUTPUTMODE, Params::OUTPUT, Params::DATASTRUCTURE, Request::URLPARAM_MANGLED, Params::EXTRA_ROUTES, Params::ACTIONS]);
        $url = GeneralUtils::removeQueryArgs($remove_params, $this->getRequestedFullURL());
        // Allow plug-ins to do their own logic to the URL
        $url = $this->hooksAPI->applyFilters('RequestUtils:getCurrentURL', $url);
