...
trait ItemProcessorManagerTrait
{
    ...
    public function getLoadedItems()
    {
        ...
        return \array_map([\PoP\ComponentModel\ItemProcessors\ProcessorItemUtils::class, 'getItemFromFullName'], \array_keys($this->itemFullNameProcessorInstances));
    }
    ...
    public function getItemProcessor(array $item)
    {
        ...
        if (!$this->hasItemBeenLoaded($item)) {
            ...
            $itemFullName = \PoP\ComponentModel\ItemProcessors\ProcessorItemUtils::getItemFullName($item);
