...
class ServiceConfiguration
{
    ...
    protected static function configureAccessControl(): void
    {
        ...
        ContainerBuilderUtils::injectValuesIntoService(AccessControlManagerInterface::class, 'addEntriesForFields', UserRolesAccessControlGroups::CAPABILITIES, [
    ...
    protected static function configureOverridingBlocks(): void
    {
        ...
        if (
            $moduleRegistry->isModuleEnabled(ClientFunctionalityModuleResolver::GRAPHIQL_EXPLORER) && $userSettingsManager->getSetting(ClientFunctionalityModuleResolver::GRAPHIQL_EXPLORER, ClientFunctionalityModuleResolver::OPTION_USE_IN_ADMIN_PERSISTED_QUERIES)
        ) {
            ContainerBuilderUtils::injectValuesIntoService(InstanceManagerInterface::class, 'overrideClass', PersistedQueryGraphiQLBlock::class, PersistedQueryGraphiQLWithExplorerBlock::class);
        }
    }
