...
class AddFeedbackForFieldDirectiveResolver extends AbstractGlobalDirectiveResolver
{
    ...
    public function resolveDirective(TypeResolverInterface $typeResolver, array &$idsDataFields, array &$succeedingPipelineIDsDataFields, array &$succeedingPipelineDirectiveResolverInstances, array &$resultIDItems, array &$unionDBKeyIDs, array &$dbItems, array &$previousDBItems, array &$variables, array &$messages, array &$dbErrors, array &$dbWarnings, array &$dbDeprecations, array &$dbNotices, array &$dbTraces, array &$schemaErrors, array &$schemaWarnings, array &$schemaDeprecations, array &$schemaNotices, array &$schemaTraces) : void
    {
        ...
        if ($target == FieldFeedbackTargetEnum::DB) {
            foreach (\array_keys($idsDataFields) as $id) {
                ...
                if (\is_null($message)) {
                    $dbErrors[(string) $id][] = [Tokens::PATH => [$this->directive], Tokens::MESSAGE => $this->translationAPI->__('The message could not be composed. Check previous errors', 'engine')];
                    continue;
                }
    ...
    {
        return [Tokens::PATH => [$this->directive], Tokens::MESSAGE => $message];
    }
    ...
    public function getSchemaDirectiveArgs(TypeResolverInterface $typeResolver) : array
    {
        ...
        return [[SchemaDefinition::ARGNAME_NAME => 'message', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_STRING, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The feedback message', 'engine'), SchemaDefinition::ARGNAME_MANDATORY => \true], [SchemaDefinition::ARGNAME_NAME => 'type', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ENUM, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The type of feedback', 'engine'), SchemaDefinition::ARGNAME_ENUM_NAME => $fieldFeedbackTypeEnum->getName(), SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($fieldFeedbackTypeEnum->getValues()), SchemaDefinition::ARGNAME_DEFAULT_VALUE => $this->getDefaultFeedbackType()], [SchemaDefinition::ARGNAME_NAME => 'target', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ENUM, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The target for the feedback', 'engine'), SchemaDefinition::ARGNAME_ENUM_NAME => $fieldFeedbackTargetEnum->getName(), SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($fieldFeedbackTargetEnum->getValues()), SchemaDefinition::ARGNAME_DEFAULT_VALUE => $this->getDefaultFeedbackTarget()]];
    }
