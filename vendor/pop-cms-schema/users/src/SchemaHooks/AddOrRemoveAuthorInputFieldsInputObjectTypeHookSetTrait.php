...
{
    protected abstract function getIDScalarTypeResolver() : IDScalarTypeResolver;
    ...
    {
        return ['authorIDs' => $this->getIDScalarTypeResolver(), 'authorSlug' => $this->getStringScalarTypeResolver(), 'excludeAuthorIDs' => $this->getIDScalarTypeResolver()];
    }
}
