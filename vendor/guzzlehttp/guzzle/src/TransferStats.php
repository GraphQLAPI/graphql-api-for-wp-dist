...
final class TransferStats
{
     ...
     */
    public function __construct(\PrefixedByPoP\Psr\Http\Message\RequestInterface $request, \PrefixedByPoP\Psr\Http\Message\ResponseInterface $response = null, $transferTime = null, $handlerErrorData = null, $handlerStats = [])
    {
