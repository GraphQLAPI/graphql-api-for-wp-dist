...
class Plugins
{
    ...
    public function init()
    {
        if ($this->validate()) {
            $this->initialize();
            \define('POP_USERMETA_INITIALIZED', \true);
        }
    }
    public function validate()
    {
        ...
        $validation = new \PoPSchema\UserMeta\Validation();
        return $validation->validate();
    }
    public function initialize()
    {
        include_once 'initialization.php';
        $initialization = new \PoPSchema\UserMeta\Initialization();
 ...
 * Initialization
 */
new \PoPSchema\UserMeta\Plugins();
