...
class MainContentModule extends \PoP\Hooks\AbstractHookSet
{
    protected function init()
    {
        $this->hooksAPI->addAction('augmentVarsProperties', [$this, 'augmentVarsProperties'], \PHP_INT_MAX, 1);
    }
    /**
    ...
    public function augmentVarsProperties(array $vars_in_array) : void
    {
        ...
        if (isset($vars['modulefilter']) && $vars['modulefilter'] == \PoP\Engine\ModuleFilters\MainContentModule::NAME) {
            $vars['maincontentmodule'] = \PoP\ModuleRouting\Facades\RouteModuleProcessorManagerFacade::getInstance()->getRouteModuleByMostAllmatchingVarsProperties(POP_PAGEMODULEGROUPPLACEHOLDER_MAINCONTENTMODULE);
        }
    }
}
