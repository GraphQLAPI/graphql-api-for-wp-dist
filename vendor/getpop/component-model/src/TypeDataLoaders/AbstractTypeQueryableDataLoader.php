...
abstract class AbstractTypeQueryableDataLoader extends AbstractTypeDataLoader implements TypeQueryableDataLoaderInterface
{
    ...
    {
        return HooksAPIFacade::getInstance()->applyFilters('GD_Dataloader_List:query:pagenumber', $query_args[GD_URLPARAM_PAGENUMBER]);
    }
    protected function getLimitParam($query_args)
    {
        return HooksAPIFacade::getInstance()->applyFilters('GD_Dataloader_List:query:limit', $query_args[GD_URLPARAM_LIMIT]);
    }
