...
trait UseTabpanelMenuPageTrait
{
    ...
    protected function enqueueTabpanelAssets(): void
    {
         ...
         */
        \wp_enqueue_style('graphql-api-tabpanel', \GRAPHQL_API_URL . 'assets/css/tabpanel.css', array(), \GRAPHQL_API_VERSION);
        \wp_enqueue_script('graphql-api-tabpanel', \GRAPHQL_API_URL . 'assets/js/tabpanel.js', array('jquery'), \GRAPHQL_API_VERSION);
    }
}
