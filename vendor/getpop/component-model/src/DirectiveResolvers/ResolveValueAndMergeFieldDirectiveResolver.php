...
final class ResolveValueAndMergeFieldDirectiveResolver extends \PoP\ComponentModel\DirectiveResolvers\AbstractGlobalFieldDirectiveResolver
{
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function resolveValueForObjects($relationalTypeResolver, $idObjects, $idFieldSet, $fieldDataAccessProvider, &$resolvedIDFieldValues, $previouslyResolvedIDFieldValues, &$messages, $engineIterationFeedbackStore) : void
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function resolveValuesForObject($relationalTypeResolver, $id, $object, $fieldSet, $fieldDataAccessProvider, &$resolvedIDFieldValues, $previouslyResolvedIDFieldValues, $engineIterationFeedbackStore) : void
    {
        /**
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function setAppStateForFieldValuePromises($relationalTypeResolver, $id, $object, $field, $value, $engineIterationFeedbackStore) : void
    {
        /**
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function resolveValueForObject($relationalTypeResolver, $id, $object, $field, $fieldDataAccessProvider, &$resolvedIDFieldValues, $previouslyResolvedIDFieldValues, $engineIterationFeedbackStore) : void
    {
