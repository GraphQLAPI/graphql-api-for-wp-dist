...
abstract class AbstractCacheControlDirectiveResolver extends \PoP\ComponentModel\DirectiveResolvers\AbstractGlobalDirectiveResolver implements \PoP\CacheControl\DirectiveResolvers\CacheControlDirectiveResolverInterface
{
    ...
    {
        $translationAPI = \PoP\Translation\Facades\TranslationAPIFacade::getInstance();
        return [[\PoP\CacheControl\Schema\SchemaDefinition::ARGNAME_NAME => 'maxAge', \PoP\CacheControl\Schema\SchemaDefinition::ARGNAME_TYPE => \PoP\CacheControl\Schema\SchemaDefinition::TYPE_INT, \PoP\CacheControl\Schema\SchemaDefinition::ARGNAME_DESCRIPTION => $translationAPI->__('Use a specific max-age value for the field, instead of the one configured in the directive', 'translate-directive')]];
    }
