            ...
            foreach (array_keys($idsDataFields) as $id) {
                ...
                if (is_null($message)) {
                    $dbErrors[(string)$id][] = [
                        ...
                        Tokens::MESSAGE => $translationAPI->__('The message could not be composed. Check previous errors', 'engine'),
                    ];
                    continue;
                }
    ...
    public function getSchemaDirectiveArgs(TypeResolverInterface $typeResolver): array
    {
        ...
        return [
            ...
            [
                ...
                SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($fieldFeedbackTypeEnum->getValues()),
            ...
            [
                ...
                SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($fieldFeedbackTargetEnum->getValues()),
