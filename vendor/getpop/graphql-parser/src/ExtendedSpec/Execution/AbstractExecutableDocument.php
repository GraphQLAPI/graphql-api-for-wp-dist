...
abstract class AbstractExecutableDocument extends ExecutableDocument implements \PoP\GraphQLParser\ExtendedSpec\Execution\ExecutableDocumentInterface
{
     ...
     */
    protected function retrieveAndAccumulateMultipleQueryExecutionOperations($multipleQueryExecutionOperations, $operation, $operations) : array
    {
        /**
        ...
        foreach ($operation->getDirectives() as $directive) {
            ...
            foreach ($dependedUponOperationNames as $dependedUponOperationName) {
                 ...
                 * @var OperationInterface
                 */
                $dependedUponOperation = $this->getOperationByName($dependedUponOperationName, $operations);
                /**
                ...
                if (\in_array($dependedUponOperation, $multipleQueryExecutionOperations)) {
                     ...
                     */
                    $multipleQueryExecutionOperations = $this->moveOperationBehindItsDependedUponOperation($multipleQueryExecutionOperations, $operation, $dependedUponOperation);
                    continue;
                }
     ...
     * @return OperationInterface[]
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $dependedUponOperation
     */
    protected function moveOperationBehindItsDependedUponOperation($multipleQueryExecutionOperations, $operation, $dependedUponOperation) : array
    {
        /** @var int */
     ...
     */
    protected function getOperationByName($operationName, $operations) : ?OperationInterface
    {
