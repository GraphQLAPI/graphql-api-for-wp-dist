 ...
 */
namespace PrefixedByPoP\Symfony\Component\String\Slugger;

use PrefixedByPoP\Symfony\Component\String\AbstractUnicodeString;
use PrefixedByPoP\Symfony\Component\String\UnicodeString;
use PrefixedByPoP\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\PrefixedByPoP\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \PrefixedByPoP\Symfony\Component\String\Slugger\SluggerInterface, \PrefixedByPoP\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \PrefixedByPoP\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \PrefixedByPoP\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
