...
class CacheControlASTNodesFactory
{
     ...
     */
    protected static $noCacheDirective;
    ...
    public static function getNoCacheDirective() : Directive
    {
        if (self::$noCacheDirective === null) {
            ...
            self::$noCacheDirective = new Directive(static::getCacheControlFieldDirectiveResolver()->getDirectiveName(), [new Argument('maxAge', new Literal(0, $nonSpecificLocation), $nonSpecificLocation)], $nonSpecificLocation);
        }
