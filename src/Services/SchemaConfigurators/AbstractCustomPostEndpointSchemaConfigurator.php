...
abstract class AbstractCustomPostEndpointSchemaConfigurator extends AbstractEndpointSchemaConfigurator
{
    ...
    /**
     * @var \GraphQLAPI\GraphQLAPI\Services\Blocks\EndpointSchemaConfigurationBlock|null
     */
    ...
    /**
     * @param \GraphQLAPI\GraphQLAPI\Services\Blocks\EndpointSchemaConfigurationBlock $endpointSchemaConfigurationBlock
     */
    final public function setEndpointSchemaConfigurationBlock($endpointSchemaConfigurationBlock): void
    {
    ...
    final protected function getEndpointSchemaConfigurationBlock(): EndpointSchemaConfigurationBlock
    {
        ...
        return $this->endpointSchemaConfigurationBlock = $this->endpointSchemaConfigurationBlock ?? $this->instanceManager->getInstance(EndpointSchemaConfigurationBlock::class);
    }
