...
use PoP\Root\App;
class CacheControlEngine implements \PoP\CacheControl\Managers\CacheControlEngineInterface
{
    /**
     * @var int|null
     */
     ...
     * @param int $maxAge
     */
    public function addMaxAge($maxAge) : void
    {
    ...
    public function getCacheControlHeaders() : ?array
    {
        if ($this->minimumMaxAge !== null) {
            ...
            return ['Cache-Control' => \sprintf('max-age=%s', $this->minimumMaxAge)];
        }
