...
class ComponentLoader
{
     ...
     */
    public static function initializeComponents(array $componentClasses, array $componentClassConfiguration = [], array $skipSchemaComponentClasses = []) : void
    {
        /**
         * Get the list of components, in the order in which they must be initialized
         */
        $orderedComponentClasses = self::getComponentsOrderedForInitialization($componentClasses);
        /**
        ...
        foreach ($orderedComponentClasses as $componentClass) {
            ...
            $componentClass::initialize($componentConfiguration, $skipSchemaForComponent, $skipSchemaComponentClasses);
        }
    }
    /**
     ...
     * @return string[]
     */
    protected static function getComponentsOrderedForInitialization(array $componentClasses) : array
    {
     ...
     */
    protected static function addComponentsOrderedForInitialization(array $componentClasses, array &$orderedComponentClasses) : void
    {
        /**
