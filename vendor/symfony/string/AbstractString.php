...
use PrefixedByPoP\Symfony\Component\String\Exception\ExceptionInterface;
use PrefixedByPoP\Symfony\Component\String\Exception\InvalidArgumentException;
use PrefixedByPoP\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractString implements \Stringable, \JsonSerializable
{
    ...
    {
        if (0 > $multiplier) {
            throw new \PrefixedByPoP\Symfony\Component\String\Exception\InvalidArgumentException(\sprintf('Multiplier must be positive, %d given.', $multiplier));
        }
        $str = clone $this;
            ...
            if (\false === ($chunks = \preg_split($delimiter, $this->string, $limit, $flags))) {
                ...
                foreach (\get_defined_constants(\true)['pcre'] as $k => $v) {
                    if ($lastError === $v && '_ERROR' === \substr($k, -6)) {
                        throw new \PrefixedByPoP\Symfony\Component\String\Exception\RuntimeException('Splitting failed with ' . $k . '.');
                    }
                }
                throw new \PrefixedByPoP\Symfony\Component\String\Exception\RuntimeException('Splitting failed with unknown error code.');
            }
        } finally {
    ...
    public function toByteString(string $toEncoding = null) : \PrefixedByPoP\Symfony\Component\String\ByteString
    {
        $b = new \PrefixedByPoP\Symfony\Component\String\ByteString();
        $toEncoding = \in_array($toEncoding, ['utf8', 'utf-8', 'UTF8'], \true) ? 'UTF-8' : $toEncoding;
        if (null === $toEncoding || $toEncoding === ($fromEncoding = $this instanceof \PrefixedByPoP\Symfony\Component\String\AbstractUnicodeString || \preg_match('//u', $b->string) ? 'UTF-8' : 'Windows-1252')) {
    ...
    public function toCodePointString() : \PrefixedByPoP\Symfony\Component\String\CodePointString
    {
        return new \PrefixedByPoP\Symfony\Component\String\CodePointString($this->string);
    }
    public function toString() : string
    {
        return $this->string;
    }
    public function toUnicodeString() : \PrefixedByPoP\Symfony\Component\String\UnicodeString
    {
        return new \PrefixedByPoP\Symfony\Component\String\UnicodeString($this->string);
    }
    /**
     * @return static
     */
