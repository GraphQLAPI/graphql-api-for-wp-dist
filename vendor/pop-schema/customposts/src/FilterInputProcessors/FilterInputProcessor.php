...
class FilterInputProcessor extends AbstractFilterInputProcessor
{
    ...
    {
        return array([self::class, self::FILTERINPUT_CUSTOMPOSTDATES], [self::class, self::FILTERINPUT_CUSTOMPOSTTYPES], [self::class, self::FILTERINPUT_CUSTOMPOSTSTATUS], [self::class, self::FILTERINPUT_GENERICCUSTOMPOSTTYPES], [self::class, self::FILTERINPUT_UNIONCUSTOMPOSTTYPES]);
    }
        ...
        switch ($filterInput[1]) {
            ...
            case self::FILTERINPUT_CUSTOMPOSTSTATUS:
                ...
                if ($value) {
                    ...
                    $value = \array_intersect($value, $customPostStatusEnum->getValues());
            ...
            case self::FILTERINPUT_GENERICCUSTOMPOSTTYPES:
                ...
                if ($value) {
                    $value = \array_intersect($value, ComponentConfiguration::getGenericCustomPostTypes());
            ...
            case self::FILTERINPUT_UNIONCUSTOMPOSTTYPES:
                ...
                if ($value) {
                    $value = \array_intersect($value, CustomPostUnionTypeHelpers::getTargetTypeResolverCustomPostTypes(CustomPostUnionTypeResolver::class));
                    $value = $this->maybeGetNonExistingCustomPostTypes($value);
                }
                $query['custompost-types'] = $value;
                break;
