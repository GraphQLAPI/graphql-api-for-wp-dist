...
abstract class AbstractRoutingManager implements RoutingManagerInterface
{
    ...
    public function getRoutes(): array
    {
        if (is_null($this->routes)) {
            $this->routes = array_filter((array)HooksAPIFacade::getInstance()->applyFilters('routes', []));
    ...
    public function getCurrentRoute(): string
    {
        ...
        // Allow to change it
        return (string)HooksAPIFacade::getInstance()->applyFilters('ApplicationState:route', $route, $nature);
    }
}
