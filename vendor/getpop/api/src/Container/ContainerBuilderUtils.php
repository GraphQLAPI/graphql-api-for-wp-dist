...
class ContainerBuilderUtils
{
    ...
    public static function addFragmentToCatalogueService(
        ...
        \PoP\Root\Container\ContainerBuilderUtils::injectValuesIntoService(PersistedFragmentManagerInterface::class, 'add', $fragmentName, $fragmentResolution, $description);
    }
    ...
    public static function addQueryToCatalogueService(
        ...
        // Inject the values into the service
        \PoP\Root\Container\ContainerBuilderUtils::injectValuesIntoService(PersistedQueryManagerInterface::class, 'add', $queryName, $queryResolution, $description);
    }
}
