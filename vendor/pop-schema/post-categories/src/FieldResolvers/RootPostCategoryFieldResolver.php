...
class RootPostCategoryFieldResolver extends AbstractQueryableFieldResolver
{
    ...
    {
        $descriptions = ['postCategory' => $this->translationAPI->__('Post category with a specific ID', 'post-categories'), 'postCategories' => $this->translationAPI->__('Post categories', 'post-categories'), 'postCategoryCount' => $this->translationAPI->__('Number of post categories', 'post-categories'), 'postCategoryNames' => $this->translationAPI->__('Names of the post categories', 'post-categories')];
    ...
    {
        $types = ['postCategory' => SchemaDefinition::TYPE_ID, 'postCategories' => SchemaDefinition::TYPE_ID, 'postCategoryCount' => SchemaDefinition::TYPE_INT, 'postCategoryNames' => SchemaDefinition::TYPE_STRING];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        ...
        switch ($fieldName) {
            case 'postCategory':
                return \array_merge($schemaFieldArgs, [[SchemaDefinition::ARGNAME_NAME => 'id', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ID, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The category ID', 'post-categories'), SchemaDefinition::ARGNAME_MANDATORY => \true]]);
            case 'postCategories':
            case 'postCategoryCount':
            case 'postCategoryNames':
    ...
    public function resolveValue(TypeResolverInterface $typeResolver, $resultItem, string $fieldName, array $fieldArgs = [], ?array $variables = null, ?array $expressions = null, array $options = [])
    {
        ...
        switch ($fieldName) {
            ...
            case 'postCategoryNames':
                ...
                $options = ['return-type' => $fieldName === 'postCategories' ? ReturnTypes::IDS : ReturnTypes::NAMES];
