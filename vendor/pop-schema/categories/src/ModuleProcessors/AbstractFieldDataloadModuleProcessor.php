...
abstract class AbstractFieldDataloadModuleProcessor extends AbstractRelationalFieldDataloadModuleProcessor
{
    ...
    {
        return array([self::class, self::MODULE_DATALOAD_RELATIONALFIELDS_CATEGORY], [self::class, self::MODULE_DATALOAD_RELATIONALFIELDS_CATEGORYLIST], [self::class, self::MODULE_DATALOAD_RELATIONALFIELDS_CATEGORYCOUNT]);
    }
    /**
    ...
    public function getFilterSubmodule(array $module) : ?array
    {
        switch ($module[1]) {
            case self::MODULE_DATALOAD_RELATIONALFIELDS_CATEGORYLIST:
                return [\PoPSchema\Categories\ModuleProcessors\FilterInnerModuleProcessor::class, \PoPSchema\Categories\ModuleProcessors\FilterInnerModuleProcessor::MODULE_FILTERINNER_CATEGORIES];
            case self::MODULE_DATALOAD_RELATIONALFIELDS_CATEGORYCOUNT:
                return [\PoPSchema\Categories\ModuleProcessors\FilterInnerModuleProcessor::class, \PoPSchema\Categories\ModuleProcessors\FilterInnerModuleProcessor::MODULE_FILTERINNER_CATEGORYCOUNT];
        }
