...
abstract class AbstractEnumTypeResolver extends AbstractTypeResolver implements \PoP\ComponentModel\TypeResolvers\EnumType\EnumTypeResolverInterface
{
     ...
     * @param string $enumValue
     */
    public final function getConsolidatedEnumValueDescription($enumValue) : ?string
    {
        // Cache the result
     ...
     * @param string $enumValue
     */
    public final function getConsolidatedEnumValueDeprecationMessage($enumValue) : ?string
    {
        // Cache the result
     ...
     * @param string $enumValue
     */
    public final function getEnumValueSchemaDefinition($enumValue) : array
    {
        // Cache the result
     ...
     * @param string $enumValue
     */
    protected function getEnumValueExtensionsSchemaDefinition($enumValue) : array
    {
     ...
     * @param string $enumValue
     */
    public final function getConsolidatedEnumValueExtensionsSchemaDefinition($enumValue) : array
    {
