...
return function (\PrefixedByPoP\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $configurator) {
    ...
    $services->load('PoP\\Engine\\ConditionalOnEnvironment\\UseComponentModelCache\\SchemaServices\\', '../../../src/ConditionalOnEnvironment/UseComponentModelCache/SchemaServices/*');
};
