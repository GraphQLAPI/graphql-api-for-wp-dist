...
class MirrorQueryDataStructureFormatter extends AbstractJSONDataStructureFormatter
{
    ...
    protected final function getASTHelperService() : ASTHelperServiceInterface
    {
        ...
        return $this->astHelperService = $this->astHelperService ?? $this->instanceManager->getInstance(ASTHelperServiceInterface::class);
    }
    /**
     ...
     * @return FieldInterface[]
     */
    protected function getFieldsFromOperations($operations, $fragments) : array
    {
        $fields = [];
     ...
     */
    protected function skipAddingDataForType($typeOutputKey) : bool
    {
