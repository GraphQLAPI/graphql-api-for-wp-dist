...
trait ConfigurableMandatoryDirectivesForFieldsTrait
{
     ...
     * Configuration entries
     */
    protected final function getEntries(TypeResolverInterface $typeResolver, array $fieldInterfaceResolverClasses, string $fieldName) : array
    {
        return $this->getMatchingEntries($this->getConfigurationEntries(), $typeResolver, $fieldInterfaceResolverClasses, $fieldName);
    }
    /**
