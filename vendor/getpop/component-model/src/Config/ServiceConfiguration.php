...
class ServiceConfiguration
{
    ...
    protected static function configure(): void
    {
        ...
        if (!Request::isMangled()) {
            ContainerBuilderUtils::injectValuesIntoService(DefinitionManagerInterface::class, 'setEnabled', false);
        }

        // Add ModuleFilters to the ModuleFilterManager
        ContainerBuilderUtils::injectServicesIntoService(ModuleFilterManagerInterface::class, 'PoP\\ComponentModel\\ModuleFilters', 'add');

        // Inject the mandatory root directives
        ContainerBuilderUtils::injectValuesIntoService(DataloadingEngineInterface::class, 'addMandatoryDirectiveClasses', [
