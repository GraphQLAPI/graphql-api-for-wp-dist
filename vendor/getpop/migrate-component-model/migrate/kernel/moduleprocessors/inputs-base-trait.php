...
trait FormInputsTrait
{
    ...
    public function getInputClass(array $module)
    {
        ...
        return \PoP\ComponentModel\GD_FormInput::class;
    }
    ...
    {
        return \PoP\ComponentModel\Modules\ModuleUtils::getModuleOutputName($module);
    }
    ...
    {
        $options = array('name' => $this->getName($module));
        return $options;
    }
}
