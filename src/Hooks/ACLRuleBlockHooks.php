...
class ACLRuleBlockHooks extends AbstractHookSet
{
    ...
    {
        $this->hooksAPI->addFilter(AccessControlGraphQLQueryConfigurator::HOOK_ACL_RULE_BLOCK_CLASS_MODULES, [$this, 'getACLRuleBlockClassModules']);
    }
    ...
    {
        return array_merge($blockClassModules, [
