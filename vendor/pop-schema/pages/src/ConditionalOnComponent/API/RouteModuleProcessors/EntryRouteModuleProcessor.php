...
class EntryRouteModuleProcessor extends AbstractEntryRouteModuleProcessor
{
    ...
    {
        $ret = array();
        $ret[RouteNatures::PAGE][] = ['module' => [FieldDataloadModuleProcessor::class, FieldDataloadModuleProcessor::MODULE_DATALOAD_RELATIONALFIELDS_PAGE], 'conditions' => ['scheme' => APISchemes::API]];
        return $ret;
    }
}
