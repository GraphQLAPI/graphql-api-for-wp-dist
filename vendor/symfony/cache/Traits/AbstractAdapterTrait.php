...
trait AbstractAdapterTrait
{
     ...
     */
    protected abstract function doFetch($ids) : iterable;
    /**
     * Confirms if the cache contains specified cache item.
     *
     * @param string $id The identifier for which to check existence
     */
    protected abstract function doHave($id) : bool;
    /**
     * Deletes all items in the pool.
     *
     * @param string $namespace The prefix used for all identifiers managed by this pool
     */
    protected abstract function doClear($namespace) : bool;
    /**
     * Removes multiple items from the pool.
     *
     * @param array $ids An array of identifiers that should be removed from the pool
     */
    protected abstract function doDelete($ids) : bool;
    /**
     ...
     * @param bool $enable
     */
    public function enableVersioning($enable = \true) : bool
    {
