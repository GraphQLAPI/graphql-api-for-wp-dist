...
abstract class AbstractRelationalFieldQueryDataModuleProcessor extends AbstractQueryDataModuleProcessor
{
    ...
    protected function getNotIsEmptyConditionField(string $field): string
    {
        ...
        return $fieldQueryInterpreter->getField('not', [
            'value' => $fieldQueryInterpreter->getField('isNull', [
                'value' => $fieldQueryInterpreter->composeField($fieldQueryInterpreter->getFieldName($field), $fieldQueryInterpreter->getFieldArgs($field) ?? QueryHelpers::getEmptyFieldArgs()),
            ]),
        ], $conditionFieldAlias, false, $fieldQueryInterpreter->getDirectives($field));
    }
