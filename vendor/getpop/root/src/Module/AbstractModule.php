...
abstract class AbstractModule implements ModuleInterface
{
     ...
     */
    public final function initialize($configuration, $skipSchema, $skipSchemaModuleClasses) : void
    {
     ...
     * @param bool $skipSchema
     */
    protected function defineRuntimeConstants($skipSchema, $skipSchemaModuleClasses) : void
    {
    }
    /**
     ...
     * @param array<string,mixed> $configuration
     */
    protected function initializeConfiguration($configuration) : void
    {
