...
class QueryASTTransformationService implements \PoPAPI\API\QueryResolution\QueryASTTransformationServiceInterface
{
     ...
     */
    public function prepareOperationFieldAndFragmentBondsForExecution($document, $operations, $fragments) : SplObjectStorage
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Document $document
     */
    public function prepareOperationFieldAndFragmentBondsForMultipleQueryExecution($document, $operations, $fragments) : SplObjectStorage
    {
     ...
     */
    protected function getOperationFieldsOrFragmentBonds($document, $operation) : array
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    public function getOperationMaximumFieldDepth($operation, $fragments) : int
    {
        /**
     ...
     */
    protected function getFieldOrFragmentBondDepth($accumulator, $fieldOrFragmentBond, $fragments) : int
    {
