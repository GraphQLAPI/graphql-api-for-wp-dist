...
return function (\PrefixedByPoP\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $configurator) {
    ...
    $services->load('GraphQLByPoP\\GraphQLServer\\ConditionalOnEnvironment\\EmbeddableFields\\SchemaServices\\', '../../../src/ConditionalOnEnvironment/EmbeddableFields/SchemaServices/*');
};
