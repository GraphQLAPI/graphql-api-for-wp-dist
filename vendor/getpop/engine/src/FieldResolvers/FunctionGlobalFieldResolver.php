...
class FunctionGlobalFieldResolver extends AbstractGlobalFieldResolver
{
    ...
    public function getSchemaFieldDescription(TypeResolverInterface $typeResolver, string $fieldName): ?string
    {
        ...
        $descriptions = [
            'getSelfProp' => sprintf($translationAPI->__('Get a property from the current object, as stored under expression `%s`', 'pop-component-model'), QueryHelpers::getExpressionQuery(Expressions::NAME_SELF)),
        ];
