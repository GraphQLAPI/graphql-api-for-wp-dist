...
class SchemaHelpers
{
    ...
    {
        return \array_filter($fieldOrDirectiveArgsSchemaDefinition, function ($fieldOrDirectiveArgSchemaDefinition) {
    ...
    {
        return \array_filter($fieldOrDirectiveArgsSchemaDefinition, function ($fieldOrDirectiveArgSchemaDefinition) {
            return $fieldOrDirectiveArgSchemaDefinition[SchemaDefinition::ARGNAME_TYPE] == SchemaDefinition::TYPE_ENUM;
        });
    }
    ...
    public static function convertToSchemaFieldArgEnumValueDefinitions(array $enumValues)
    {
        ...
        foreach ($enumValues as $enumValue) {
            $enumValueDefinitions[$enumValue] = [SchemaDefinition::ARGNAME_NAME => $enumValue];
        }
        ...
        foreach ($enumValuesOrDefinitions as $fieldArgName => $fieldArgEnumValuesOrDefinitions) {
            ...
            if (\is_array($fieldArgEnumValuesOrDefinitions[$firstElemKey])) {
                ...
                foreach ($fieldArgEnumValuesOrDefinitions as $enumValue) {
                    $enumValueDefinitions[$fieldArgName][$enumValue] = [SchemaDefinition::ARGNAME_NAME => $enumValue];
                }
            }
        }
        return $enumValueDefinitions;
