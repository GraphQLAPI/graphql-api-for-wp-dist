...
class Menu extends AbstractMenu
{
    ...
    public function addMenuPagesTop(): void
    {
        ...
        \add_menu_page(__('GraphQL API', 'graphql-api'), __('GraphQL API', 'graphql-api'), $schemaEditorAccessCapability, self::NAME, function () {
        ...
        if (
            $hookName = \add_submenu_page(self::NAME, __('GraphiQL', 'graphql-api'), __('GraphiQL', 'graphql-api'), $schemaEditorAccessCapability, self::NAME, [$graphiQLMenuPage, 'print'])
        ) {
        ...
        if (
            $hookName = \add_submenu_page(self::NAME, __('Interactive Schema', 'graphql-api'), __('Interactive Schema', 'graphql-api'), $schemaEditorAccessCapability, $graphQLVoyagerMenuPage->getScreenID(), [$graphQLVoyagerMenuPage, 'print'])
        ) {
    ...
    public function addMenuPagesBottom(): void
    {
        ...
        if (
            $hookName = \add_submenu_page(self::NAME, __('Modules', 'graphql-api'), __('Modules', 'graphql-api'), 'manage_options', $modulesMenuPage->getScreenID(), $callable)
        ) {
        ...
        if (
            $hookName = \add_submenu_page(self::NAME, __('Settings', 'graphql-api'), __('Settings', 'graphql-api'), 'manage_options', $settingsMenuPage->getScreenID(), [$settingsMenuPage, 'print'])
        ) {
        ...
        if (isset($_GET['page']) && $_GET['page'] == $aboutMenuPage->getScreenID()) {
            if (
                $hookName = \add_submenu_page(self::NAME, __('About', 'graphql-api'), __('About', 'graphql-api'), 'read', $aboutMenuPage->getScreenID(), [$aboutMenuPage, 'print'])
            ) {
        ...
        if (
            $hookName = \add_submenu_page(self::NAME, __('Support', 'graphql-api'), __('Support', 'graphql-api'), 'read', $supportMenuPage->getScreenID(), [$supportMenuPage, 'print'])
        ) {
