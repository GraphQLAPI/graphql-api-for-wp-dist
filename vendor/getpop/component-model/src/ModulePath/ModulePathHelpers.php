...
class ModulePathHelpers implements ModulePathHelpersInterface
{
    ...
    {
        return implode(POP_CONSTANT_MODULESTARTPATH_SEPARATOR, array_map([ModuleUtils::class, 'getModuleOutputName'], $modulepath));
    }

    public function recastModulePath(string $modulepath_as_string)
    {
        return array_map([ModuleUtils::class, 'getModuleFromOutputName'], explode(POP_CONSTANT_MODULESTARTPATH_SEPARATOR, $modulepath_as_string));
    }
}
