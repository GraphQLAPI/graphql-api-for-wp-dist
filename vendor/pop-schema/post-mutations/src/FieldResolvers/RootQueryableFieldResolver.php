...
class RootQueryableFieldResolver extends AbstractQueryableFieldResolver
{
    ...
    {
        $types = ['myPosts' => SchemaDefinition::TYPE_ID, 'myPostCount' => SchemaDefinition::TYPE_INT, 'myPost' => SchemaDefinition::TYPE_ID];
    ...
    {
        $descriptions = ['myPosts' => $this->translationAPI->__('Posts by the logged-in user', 'post-mutations'), 'myPostCount' => $this->translationAPI->__('Number of posts by the logged-in user', 'post-mutations'), 'myPost' => $this->translationAPI->__('Post with a specific ID', 'post-mutations')];
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        ...
        switch ($fieldName) {
            ...
            case 'myPost':
                return \array_merge($schemaFieldArgs, [[SchemaDefinition::ARGNAME_NAME => 'id', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_ID, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('The post ID', 'post-mutations'), SchemaDefinition::ARGNAME_MANDATORY => \true]]);
        }
    ...
    protected function getFieldDefaultFilterDataloadingModule(TypeResolverInterface $typeResolver, string $fieldName, array $fieldArgs = []) : ?array
    {
        switch ($fieldName) {
            case 'myPosts':
                return [FieldDataloadModuleProcessor::class, FieldDataloadModuleProcessor::MODULE_DATALOAD_RELATIONALFIELDS_MYPOSTLIST];
            case 'myPostCount':
                return [FieldDataloadModuleProcessor::class, FieldDataloadModuleProcessor::MODULE_DATALOAD_RELATIONALFIELDS_MYPOSTCOUNT];
        }
