    ...
    public function getModelInstanceComponentsFromVars($components)
    {
        ...
        switch ($vars['nature']) {
            case RouteNatures::USER:
                ...
                $component_types = $this->hooksAPI->applyFilters('\\PoP\\ComponentModel\\ModelInstanceProcessor_Utils:components_from_vars:type:userrole', array(ModelInstanceComponentTypes::USER_ROLE));
