...
class DBEntriesHookSet extends AbstractHookSet
{
    ...
    public function moveEntriesUnderDBName($dbNameToFieldNames) : array
    {
        ...
        $dbNameToFieldNames['meta'] = App::applyFilters('PoPAPI\\API\\DataloaderHooks:metaFields', ['fullSchema', 'typeName']);
        $dbNameToFieldNames['context'] = App::applyFilters('PoPAPI\\API\\DataloaderHooks:contextFields', ['var', 'context']);
