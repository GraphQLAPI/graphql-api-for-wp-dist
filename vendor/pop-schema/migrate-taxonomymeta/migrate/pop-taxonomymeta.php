...
class Plugins
{
    ...
    public function init()
    {
        if ($this->validate()) {
            $this->initialize();
            \define('POP_TAXONOMYMETA_INITIALIZED', \true);
        }
    }
    public function validate()
    {
        ...
        $validation = new \PoPSchema\TaxonomyMeta\Validation();
        return $validation->validate();
    }
    public function initialize()
    {
        include_once 'initialization.php';
        $initialization = new \PoPSchema\TaxonomyMeta\Initialization();
 ...
 * Initialization
 */
new \PoPSchema\TaxonomyMeta\Plugins();
