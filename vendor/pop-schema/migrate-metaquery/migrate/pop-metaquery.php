...
class Plugins
{
    ...
    public function init()
    {
        if ($this->validate()) {
            $this->initialize();
            \define('POP_METAQUERY_INITIALIZED', \true);
        }
    }
    public function validate()
    {
        ...
        $validation = new \PoPSchema\MetaQuery\Validation();
        return $validation->validate();
    }
    public function initialize()
    {
        include_once 'initialization.php';
        $initialization = new \PoPSchema\MetaQuery\Initialization();
 ...
 * Initialization
 */
new \PoPSchema\MetaQuery\Plugins();
