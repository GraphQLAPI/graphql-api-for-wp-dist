...
class AdminEndpointResolver extends AbstractEndpointResolver
{
    ...
    public function __construct(EndpointHelpers $endpointHelpers, UserAuthorizationInterface $userAuthorization, QueryRetrieverInterface $queryRetrieverInterface)
    {
