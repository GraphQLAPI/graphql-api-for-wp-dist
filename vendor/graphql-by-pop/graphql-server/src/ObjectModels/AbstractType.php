...
abstract class AbstractType extends \GraphQLByPoP\GraphQLServer\ObjectModels\AbstractSchemaDefinitionReferenceObject
{
    ...
    {
        return $this->schemaDefinition[\PoP\ComponentModel\Schema\SchemaDefinition::ARGNAME_NAMESPACED_NAME];
    }
    public function getElementName() : string
    {
        return $this->schemaDefinition[\PoP\ComponentModel\Schema\SchemaDefinition::ARGNAME_ELEMENT_NAME];
    }
    /**
