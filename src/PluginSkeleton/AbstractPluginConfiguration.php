...
abstract class AbstractPluginConfiguration
{
    ...
    protected function defineEnvironmentConstantsFromCallbacks(): void
    {
        ...
        foreach ($mappings as $mapping) {
            ...
            \add_filter($hookName, function () use ($callback) {
                return $callback();
            });
        }
    }
    ...
    {
        return array_merge_recursive($this->getPredefinedComponentClassConfiguration(), $this->getBasedOnModuleEnabledStateComponentClassConfiguration());
    }
