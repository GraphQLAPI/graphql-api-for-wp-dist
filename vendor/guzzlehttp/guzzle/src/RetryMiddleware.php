...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\PrefixedByPoP\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\PrefixedByPoP\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\PrefixedByPoP\Psr\Http\Message\RequestInterface $request, array $options, \PrefixedByPoP\Psr\Http\Message\ResponseInterface $response = null)
    {
