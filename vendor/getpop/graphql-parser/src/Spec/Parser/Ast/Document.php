...
class Document implements \PoP\GraphQLParser\Spec\Parser\Ast\DocumentInterface
{
     ...
     * @param string $name
     */
    public function getFragment($name) : ?\PoP\GraphQLParser\Spec\Parser\Ast\Fragment
    {
        foreach ($this->fragments as $fragment) {
     ...
     */
    protected function getFragmentReferencesInOperation($operation) : array
    {
     ...
     * @return FragmentReference[]
     */
    protected function getFragmentReferencesInFieldsOrFragmentBonds($fieldsOrFragmentBonds, &$referencedFragmentNames) : array
    {
        $fragmentReferences = [];
     ...
     */
    protected function getFragmentReferencesInFragment($fragment) : array
    {
        $referencedFragmentNames = [];
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    public function getVariableReferencesInOperation($operation) : array
    {
     ...
     * @return VariableReference[]
     */
    protected function getVariableReferencesInFieldsOrFragments($fieldsOrFragmentBonds) : array
    {
        $variableReferences = [];
        foreach ($fieldsOrFragmentBonds as $fieldOrFragmentBond) {
     ...
     * @return VariableReference[]
     */
    protected function getVariableReferencesInArguments($arguments) : array
    {
        $variableReferences = [];
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function assertArgumentsUniqueInOperation($operation) : void
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Fragment $fragment
     */
    protected function assertArgumentsUniqueInFragment($fragment) : void
    {
     ...
     * @throws InvalidRequestException
     */
    protected function assertArgumentsUniqueInFieldsOrInlineFragments($fieldsOrFragmentBonds) : void
    {
        foreach ($fieldsOrFragmentBonds as $fieldOrFragmentBond) {
            if ($fieldOrFragmentBond instanceof \PoP\GraphQLParser\Spec\Parser\Ast\FragmentReference) {
                continue;
     ...
     * @throws InvalidRequestException
     */
    protected function assertArgumentNamesUnique($arguments) : void
    {
        $argumentNames = [];
        foreach ($arguments as $argument) {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function setAncestorsUnderOperation($astNodeAncestors, $operation) : void
    {
        foreach ($operation->getVariables() as $variable) {
     ...
     */
    protected function setAncestorsUnderVariable($astNodeAncestors, $variable) : void
    {
     ...
     */
    protected function setAncestorsUnderArgument($astNodeAncestors, $argument) : void
    {
     ...
     */
    protected function setAncestorsUnderArgumentValueAst($astNodeAncestors, $argumentValueAST) : void
    {
     ...
     */
    protected function setAncestorsUnderInputList($astNodeAncestors, $inputList) : void
    {
    ...
    /**
     * @param SplObjectStorage<AstInterface,AstInterface> $astNodeAncestors
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\ArgumentValue\InputObject $inputObject
     */
    protected function setAncestorsUnderInputObject($astNodeAncestors, $inputObject) : void
    {
     ...
     */
    protected function setAncestorsUnderFieldOrFragmentBond($astNodeAncestors, $fieldOrFragmentBond) : void
    {
        if ($fieldOrFragmentBond instanceof \PoP\GraphQLParser\Spec\Parser\Ast\LeafField) {
            /** @var LeafField */
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Fragment $fragment
     */
    protected function setAncestorsUnderFragment($astNodeAncestors, $fragment) : void
    {
