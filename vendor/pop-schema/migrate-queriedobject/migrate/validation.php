...
class Validation
{
    ...
    {
        return \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->applyFilters('PoP_QueriedObject_Validation:provider-validation-class', null);
    }
    ...
    {
        $this->providerinstall_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Queried Object', 'pop-queriedobject'));
    }
    public function providerinitialize_warning()
    {
        $this->providerinitialize_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Queried Object', 'pop-queriedobject'));
    }
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Queried Object', 'pop-queriedobject'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-queriedobject'));
    }
    public function installWarning()
    {
        $this->dependencyInstallationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Queried Object', 'pop-queriedobject'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-queriedobject'), 'https://github.com/leoloso/PoP');
    }
    public function versionWarning()
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Queried Object', 'pop-queriedobject'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-queriedobject'), 'https://github.com/leoloso/PoP', POP_QUERIEDOBJECT_POP_ENGINE_MIN_VERSION);
    }
