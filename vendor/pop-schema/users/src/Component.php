...
class Component extends AbstractComponent
{
    ...
    protected static function initializeContainerServices(array $configuration = [], bool $skipSchema = \false, array $skipSchemaComponentClasses = []) : void
    {
        ...
        if (\class_exists(CustomPostsComponent::class)) {
            ...
            self::initSchemaServices(\dirname(__DIR__), $skipSchema || \in_array(\PoPSchema\CustomPosts\Component::class, $skipSchemaComponentClasses), '/ConditionalOnComponent/CustomPosts');
            if (\class_exists(RESTAPIComponent::class) && RESTAPIComponent::isEnabled()) {
