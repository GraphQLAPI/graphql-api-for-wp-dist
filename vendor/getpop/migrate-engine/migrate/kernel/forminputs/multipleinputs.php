...
class GD_FormInput_MultipleInputs extends \PoP\Engine\GD_FormInput_MultiSelect
{
    public $subnames;
    ...
    protected function getValueFromSource(array $source)
    {
        ...
        foreach ($this->getSubnames() as $subname) {
            $fullsubname = \PoP\ComponentModel\PoP_InputUtils::getMultipleinputsName($name, $subname);
