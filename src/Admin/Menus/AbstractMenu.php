...
abstract class AbstractMenu
{
    ...
    public function __construct()
    {
        ...
        $this->menuPageObjects = array_map(function ($menuPageClass) use ($instanceManager): AbstractMenuPage {
            /**
    ...
    public function initialize(): void
    {
         ...
         */
        \add_action('admin_menu', [$this, 'addMenuPagesTop'], 9);
        /**
         * High priority to execute after adding the menus for the CPTs
         */
        \add_action('admin_menu', [$this, 'addMenuPagesBottom'], 20);
