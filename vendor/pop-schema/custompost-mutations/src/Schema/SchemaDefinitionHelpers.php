...
class SchemaDefinitionHelpers
{
    ...
    public static function getCreateUpdateCustomPostSchemaFieldArgs(
        ...
        if (!isset(self::$schemaFieldArgsCache[$key])) {
            ...
            $schemaFieldDefinition = array_merge($addCustomPostID ? [
                [
                ...
                [
                    ...
                    SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($customPostStatusEnum->getValues()),
                ],
