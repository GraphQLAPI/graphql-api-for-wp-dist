...
class TaxonomyFieldResolver extends AbstractDBDataFieldResolver
{
    ...
    {
        return [AbstractTaxonomyTypeResolver::class];
    }
    public function getImplementedFieldInterfaceResolverClasses() : array
    {
        return [WithMetaFieldInterfaceResolver::class];
    }
    ...
    public function resolveValue(TypeResolverInterface $typeResolver, $resultItem, string $fieldName, array $fieldArgs = [], ?array $variables = null, ?array $expressions = null, array $options = [])
    {
        ...
        switch ($fieldName) {
            case 'metaValue':
            case 'metaValues':
                return $taxonomyMetaAPI->getTaxonomyTermMeta($typeResolver->getID($taxonomy), $fieldArgs['key'], $fieldName === 'metaValue');
        }
