...
class IsCustomPostFieldInterfaceResolver extends QueryableFieldInterfaceResolver
{
    ...
    {
        return array_merge(parent::getFieldNamesToImplement(), [
            'content',
            'status',
            'isStatus',
            'date',
            ...
            case 'date':
                return array_merge($schemaFieldArgs, [
                    [
                        ...
                        SchemaDefinition::ARGNAME_DESCRIPTION => sprintf($translationAPI->__('Date format, as defined in %s', 'customposts'), 'https://www.php.net/manual/en/function.date.php'),
            ...
            case 'datetime':
                return array_merge($schemaFieldArgs, [
                    [
                        SchemaDefinition::ARGNAME_NAME => 'format',
                        SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_STRING,
                        SchemaDefinition::ARGNAME_DESCRIPTION => sprintf($translationAPI->__('Date and time format, as defined in %s. Default value: \'%s\' (for current year date) or \'%s\' (otherwise)', 'customposts'), 'https://www.php.net/manual/en/function.date.php', 'j M, H:i', 'j M Y, H:i'),
                    ],
                ]);
            ...
            case 'content':
                ...
                return array_merge($schemaFieldArgs, [
                    [
                        ...
                        SchemaDefinition::ARGNAME_ENUM_VALUES => SchemaHelpers::convertToSchemaFieldArgEnumValueDefinitions($customPostContentFormatEnum->getValues()),
