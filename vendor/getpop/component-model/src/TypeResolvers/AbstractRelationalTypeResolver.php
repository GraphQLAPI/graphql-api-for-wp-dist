...
abstract class AbstractRelationalTypeResolver extends \PoP\ComponentModel\TypeResolvers\AbstractTypeResolver implements \PoP\ComponentModel\TypeResolvers\RelationalTypeResolverInterface
{
    ...
    /**
     * @param \PoP\ComponentModel\Registries\MandatoryFieldDirectiveResolverRegistryInterface $mandatoryFieldDirectiveResolverRegistry
     */
    public final function setMandatoryFieldDirectiveResolverRegistry($mandatoryFieldDirectiveResolverRegistry) : void
    {
    ...
    protected final function getMandatoryFieldDirectiveResolverRegistry() : MandatoryFieldDirectiveResolverRegistryInterface
    {
        ...
        return $this->mandatoryFieldDirectiveResolverRegistry = $this->mandatoryFieldDirectiveResolverRegistry ?? $this->instanceManager->getInstance(MandatoryFieldDirectiveResolverRegistryInterface::class);
    }
    /**
     * @param \PoP\ComponentModel\DirectivePipeline\DirectivePipelineServiceInterface $directivePipelineService
     */
    public final function setDirectivePipelineService($directivePipelineService) : void
    {
    ...
    protected final function getDirectivePipelineService() : DirectivePipelineServiceInterface
    {
        ...
        return $this->directivePipelineService = $this->directivePipelineService ?? $this->instanceManager->getInstance(DirectivePipelineServiceInterface::class);
    }
     ...
     */
    protected function getDirective($directiveName) : Directive
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function validateAndResolveFieldDirectiveResolverToFields($directives, $directiveFields, $engineIterationFeedbackStore) : SplObjectStorage
    {
        /** @var SplObjectStorage<FieldDirectiveResolverInterface,FieldInterface[]> */
     ...
     * @param \PoP\ComponentModel\DirectiveResolvers\FieldDirectiveResolverInterface $fieldDirectiveResolver
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    protected function isFieldDirectiveResolverInRightDirectiveLocation($fieldDirectiveResolver, $field) : bool
    {
     ...
     */
    protected function getFieldDirectiveResolvers($directive, $fields) : ?SplObjectStorage
    {
        $directiveName = $directive->getName();
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Directive $directive
     */
    protected function getUniqueFieldDirectiveResolverForDirective($directiveResolver, $directive) : FieldDirectiveResolverInterface
    {
     ...
     */
    protected function getIDsToQuery($idFieldSet) : array
    {
     ...
     * @return array<string|int>
     */
    protected function getResolvedObjectIDs($objectIDs) : array
    {
        return $objectIDs;
    }
    /**
     ...
     * @return Directive[]
     */
    protected function addMandatoryDirectivesForDirectives($directives) : array
    {
    ...
    protected function calculateAllRelationalTypeResolverDecorators() : array
    {
        ...
        foreach ($classes as $class) {
            $typeResolverDecorators = \array_merge($typeResolverDecorators, $this->calculateAllRelationalTypeResolverDecoratorsForRelationalTypeOrInterfaceTypeResolverClass($class));
        }
     ...
     * @param string $class
     */
    protected function calculateAllRelationalTypeResolverDecoratorsForRelationalTypeOrInterfaceTypeResolverClass($class) : array
    {
        $typeResolverDecorators = [];
        ...
        do {
            ...
            $typeResolverDecorators = \array_merge($typeResolverDecorators, $attachedRelationalTypeResolverDecorators);
     ...
     */
    protected function filterDirectiveNameResolvers($directiveNameResolvers) : array
    {
     ...
     * @param \PoP\ComponentModel\Engine\EngineIterationFieldSet $engineIterationFieldSet
     */
    protected function getFieldsToEnqueueFillingObjectsFromIDs($engineIterationFieldSet) : array
    {
        /**
     ...
     * @param string|int $id
     * @param \PoP\ComponentModel\Engine\EngineIterationFieldSet $fieldSet
     */
    protected function doEnqueueFillingObjectsFromIDs($fields, $mandatoryDirectivesForFields, $mandatorySystemDirectives, $id, $fieldSet) : void
    {
        foreach ($fields as $field) {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function processFillingObjectsFromIDs($unionTypeOutputKeyIDs, $idObjects, $previouslyResolvedIDFieldValues, &$resolvedIDFieldValues, &$messages, $engineIterationFeedbackStore) : void
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function getFieldObjectTypeResolverObjectFieldData($fields, $fieldIDs, $idObjects, $engineIterationFeedbackStore) : SplObjectStorage
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected function getObjectTypeResolverObjectFieldData($field, $ids, $idObjects, $engineIterationFeedbackStore) : ?SplObjectStorage
    {
     ...
     * @param \PoP\ComponentModel\Feedback\EngineIterationFeedbackStore $engineIterationFeedbackStore
     */
    protected abstract function doGetObjectTypeResolverObjectFieldData($field, $ids, $idObjects, $engineIterationFeedbackStore) : ?SplObjectStorage;
    /**
     * @return array<string,FieldDirectiveResolverInterface>
     * @param bool $global
     */
