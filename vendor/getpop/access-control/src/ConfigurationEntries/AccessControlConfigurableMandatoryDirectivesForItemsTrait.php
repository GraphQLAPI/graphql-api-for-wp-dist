...
trait AccessControlConfigurableMandatoryDirectivesForItemsTrait
{
    ...
    protected function doesSchemaModeProcessNullControlEntry() : bool
    {
        ...
        return ComponentConfiguration::usePrivateSchemaMode() && $individualControlSchemaMode == SchemaModes::PRIVATE_SCHEMA_MODE || !ComponentConfiguration::usePrivateSchemaMode() && $individualControlSchemaMode == SchemaModes::PUBLIC_SCHEMA_MODE;
    }
