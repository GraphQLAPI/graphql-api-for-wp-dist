...
class ConditionalComponent
{
    ...
    {
        self::maybeInitYAMLSchemaServices(\PoPSchema\Users\Component::$COMPONENT_DIR, $skipSchema, '/Conditional/CustomPosts');
        if (\class_exists('\\PoP\\RESTAPI\\Component') && !\in_array(\PoP\RESTAPI\Component::class, $skipSchemaComponentClasses)) {
            \PoPSchema\Users\Conditional\CustomPosts\Conditional\RESTAPI\ConditionalComponent::initialize($configuration, $skipSchema);
        }
    }
    /**
     * Boot component
