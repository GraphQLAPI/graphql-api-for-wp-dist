...
class ContainerBuilderFactory
{
     ...
     * @return void
     */
    public static function init(bool $cacheContainerConfiguration = \false, ?string $namespace = null, ?string $directory = null) : void
    {
        ...
        if ($cacheSetupSuccess) {
            ...
            $containerConfigCache = new \PrefixedByPoP\Symfony\Component\Config\ConfigCache(self::$cacheFile, $isDebug);
        ...
        if (!self::$cached) {
            self::$instance = new \PrefixedByPoP\Symfony\Component\DependencyInjection\ContainerBuilder();
        } else {
