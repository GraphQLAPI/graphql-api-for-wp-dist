...
class GraphQLVoyagerMenuPage extends AbstractMenuPage
{
    ...
    protected function enqueueAssets(): void
    {
        ...
        // CSS
        \wp_enqueue_style('graphql-api-voyager-client', \GRAPHQL_API_URL . 'assets/css/voyager-client.css', array(), \GRAPHQL_API_VERSION);
        \wp_enqueue_style('graphql-api-voyager', \GRAPHQL_API_URL . 'assets/css/vendors/voyager.css', array(), \GRAPHQL_API_VERSION);

        // JS: execute them all in the footer
        $this->enqueueReactAssets(true);
        \wp_enqueue_script('graphql-api-voyager', \GRAPHQL_API_URL . 'assets/js/vendors/voyager.min.js', array('graphql-api-react-dom'), \GRAPHQL_API_VERSION, true);
        \wp_enqueue_script('graphql-api-voyager-client', \GRAPHQL_API_URL . 'assets/js/voyager-client.js', array('graphql-api-voyager'), \GRAPHQL_API_VERSION, true);

        // Load data into the script
        \wp_localize_script('graphql-api-voyager-client', 'graphQLByPoPGraphiQLSettings', array(
