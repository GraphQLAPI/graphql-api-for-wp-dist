...
{
    /**
     * @var \PoPSchema\Comments\ConditionalOnComponent\Users\TypeAPIs\CommentTypeAPIInterface
     */
    ...
    {
        $descriptions = ['author' => $this->translationAPI->__('Comment\'s author', 'comments')];
