...
{
    /**
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getOutput($enableModifyingEngineBehaviorViaRequest) : string
    {
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getDataStructure($enableModifyingEngineBehaviorViaRequest) : ?string
    {
        $default = null;
        if (!$enableModifyingEngineBehaviorViaRequest) {
            return $default;
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getScheme($enableModifyingEngineBehaviorViaRequest) : ?string
    {
        $default = null;
        if (!$enableModifyingEngineBehaviorViaRequest) {
            return $default;
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getDataSourceSelector($enableModifyingEngineBehaviorViaRequest) : string
    {
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getDataOutputMode($enableModifyingEngineBehaviorViaRequest) : string
    {
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getDBOutputMode($enableModifyingEngineBehaviorViaRequest) : string
    {
     ...
     * @param bool $enableModifyingEngineBehaviorViaRequest
     */
    public static function getDataOutputItems($enableModifyingEngineBehaviorViaRequest) : array
    {
