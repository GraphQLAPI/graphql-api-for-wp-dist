...
class MenuItemFieldResolver extends AbstractDBDataFieldResolver
{
    ...
    {
        return ['title', 'alt', 'url', 'classes', 'target', 'additionalAttrs', 'objectID', 'parentID'];
    }
    public function getSchemaFieldType(TypeResolverInterface $typeResolver, string $fieldName) : string
    {
        $types = ['title' => SchemaDefinition::TYPE_STRING, 'alt' => SchemaDefinition::TYPE_STRING, 'url' => SchemaDefinition::TYPE_URL, 'classes' => SchemaDefinition::TYPE_STRING, 'target' => SchemaDefinition::TYPE_STRING, 'additionalAttrs' => SchemaDefinition::TYPE_STRING, 'objectID' => SchemaDefinition::TYPE_ID, 'parentID' => SchemaDefinition::TYPE_ID];
        return $types[$fieldName] ?? parent::getSchemaFieldType($typeResolver, $fieldName);
    }
    public function getSchemaFieldDescription(TypeResolverInterface $typeResolver, string $fieldName) : ?string
    {
        $descriptions = ['title' => $this->translationAPI->__('Menu item title', 'menus'), 'alt' => $this->translationAPI->__('Menu item alt', 'menus'), 'url' => $this->translationAPI->__('Menu item URL', 'menus'), 'classes' => $this->translationAPI->__('Menu item classes', 'menus'), 'target' => $this->translationAPI->__('Menu item target', 'menus'), 'additionalAttrs' => $this->translationAPI->__('Menu item additional attributes', 'menus'), 'objectID' => $this->translationAPI->__('ID of the object linked to by the menu item ', 'menus'), 'parentID' => $this->translationAPI->__('Menu item\'s parent ID', 'menus')];
