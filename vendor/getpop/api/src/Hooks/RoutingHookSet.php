...
class RoutingHookSet extends AbstractHookSet
{
    ...
    public function __construct(HooksAPIInterface $hooksAPI, TranslationAPIInterface $translationAPI, InstanceManagerInterface $instanceManager, CMSServiceInterface $cmsService, RequestHelperServiceInterface $requestHelperService)
    {
    ...
    {
        $this->hooksAPI->addFilter('\\PoP\\Routing:uri-route', array($this, 'getURIRoute'));
        $this->hooksAPI->addFilter('\\PoP\\ComponentModel\\Engine:getExtraRoutes', array($this, 'getExtraRoutes'), 10, 1);
    }
