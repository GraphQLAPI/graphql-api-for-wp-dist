 ...
 */
class ServiceLocator implements \PrefixedByPoP\Symfony\Contracts\Service\ServiceProviderInterface
{
     ...
     * @return static
     */
    public function withContext(string $externalId, \PrefixedByPoP\Symfony\Component\DependencyInjection\Container $container)
    {
        $locator = clone $this;
    ...
    private function createNotFoundException(string $id) : \PrefixedByPoP\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \PrefixedByPoP\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \PrefixedByPoP\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \PrefixedByPoP\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    ...
    {
        return new \PrefixedByPoP\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
