...
class PluginConfiguration
{
     ...
     */
    protected static $normalizedOptionValuesCache = null;
    ...
    protected static function defineEnvironmentConstantsFromSettings(): void
    {
        ...
        $mappings = [
            ...
            [
                ...
                'callback' => function ($value) {
                    return self::getURLPathSettingValue($value, EndpointFunctionalityModuleResolver::SINGLE_ENDPOINT, EndpointFunctionalityModuleResolver::OPTION_PATH);
                },
                'condition' => 'any',
            ],
            ...
            [
                ...
                'option' => EndpointFunctionalityModuleResolver::OPTION_PATH,
                'callback' => function ($value) {
                    return self::getCPTPermalinkBasePathSettingValue($value, EndpointFunctionalityModuleResolver::CUSTOM_ENDPOINTS, EndpointFunctionalityModuleResolver::OPTION_PATH);
                },
                'condition' => 'any',
            ],
            ...
            [
                ...
                'option' => EndpointFunctionalityModuleResolver::OPTION_PATH,
                'callback' => function ($value) {
                    return self::getCPTPermalinkBasePathSettingValue($value, EndpointFunctionalityModuleResolver::PERSISTED_QUERIES, EndpointFunctionalityModuleResolver::OPTION_PATH);
                },
                'condition' => 'any',
            ],
            ...
            [
                ...
                'option' => EndpointFunctionalityModuleResolver::OPTION_PATH,
                'callback' => function ($value) {
                    return self::getURLPathSettingValue($value, ClientFunctionalityModuleResolver::GRAPHIQL_FOR_SINGLE_ENDPOINT, EndpointFunctionalityModuleResolver::OPTION_PATH);
                },
                'condition' => 'any',
            ],
            // Voyager client slug
            [
                ...
                'option' => EndpointFunctionalityModuleResolver::OPTION_PATH,
                'callback' => function ($value) {
                    return self::getURLPathSettingValue($value, ClientFunctionalityModuleResolver::INTERACTIVE_SCHEMA_FOR_SINGLE_ENDPOINT, EndpointFunctionalityModuleResolver::OPTION_PATH);
                },
                'condition' => 'any',
            ],
            ...
            [
                ...
                'callback' => function ($value) use ($moduleRegistry) {
                    return $moduleRegistry->isModuleEnabled(SchemaConfigurationFunctionalityModuleResolver::PUBLIC_PRIVATE_SCHEMA) && $value;
                },
                'condition' => 'any',
            ],
            // Use namespacing?
            ...
            [
                ...
                'callback' => function ($value) use ($moduleRegistry) {
                    return $moduleRegistry->isModuleEnabled(OperationalFunctionalityModuleResolver::NESTED_MUTATIONS) && $value != MutationSchemes::STANDARD;
                },
            ],
            ...
            [
                ...
                'option' => OperationalFunctionalityModuleResolver::OPTION_SCHEME,
                'callback' => function ($value) use ($moduleRegistry) {
                    return $moduleRegistry->isModuleEnabled(OperationalFunctionalityModuleResolver::NESTED_MUTATIONS) && $value == MutationSchemes::NESTED_WITHOUT_REDUNDANT_ROOT_FIELDS;
                },
            ],
        ...
        foreach ($mappings as $mapping) {
            ...
            $hookName = ComponentConfigurationHelpers::getHookName($mapping['class'], $envVariable);
            ...
            \add_filter($hookName, function () use ($userSettingsManager, $optionModule, $option, $callback) {
    ...
    public static function getSkippingSchemaComponentClasses(): array
    {
        ...
        $skipSchemaModuleComponentClasses = array_filter($maybeSkipSchemaModuleComponentClasses, function ($module) use ($moduleRegistry) {
            return !$moduleRegistry->isModuleEnabled($module);
        }, ARRAY_FILTER_USE_KEY);
        return GeneralUtils::arrayFlatten(array_values($skipSchemaModuleComponentClasses));
    }
}
