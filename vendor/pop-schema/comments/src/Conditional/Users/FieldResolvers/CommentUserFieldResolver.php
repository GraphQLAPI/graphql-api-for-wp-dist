...
class CommentUserFieldResolver extends \PoP\ComponentModel\FieldResolvers\AbstractDBDataFieldResolver
{
    ...
    public function getSchemaFieldDescription(\PoP\ComponentModel\TypeResolvers\TypeResolverInterface $typeResolver, string $fieldName) : ?string
    {
        ...
        $descriptions = ['author' => $translationAPI->__('Comment\'s author', 'comments')];
