...
class Component extends AbstractComponent
{
    ...
    {
        return [\PoPSchema\Meta\Component::class, \PoPSchema\CustomPosts\Component::class];
    }
    /**
     * Initialize services
     *
    ...
    {
        \PoPSchema\CustomPostMeta\ComponentConfiguration::setConfiguration($configuration);
