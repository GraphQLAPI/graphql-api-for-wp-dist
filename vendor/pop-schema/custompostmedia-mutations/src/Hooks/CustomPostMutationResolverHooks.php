...
class CustomPostMutationResolverHooks extends AbstractHookSet
{
    ...
    public function getSchemaFieldArgs(
        ...
        $fieldArgs[] = [
            ...
            SchemaDefinition::ARGNAME_DESCRIPTION => sprintf($this->translationAPI->__('The ID of the featured image (of type %s)', 'custompost-mutations'), MediaTypeResolver::NAME),
        ];
        return $fieldArgs;
    }
