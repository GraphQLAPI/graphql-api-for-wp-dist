...
abstract class AbstractTaxonomy
{
    ...
    public function initTaxonomy(): void
    {
        ...
        $labels = $this->getTaxonomyLabels($this->getTaxonomyName(true), $names_uc, $this->getTaxonomyName(false), $this->getTaxonomyPluralNames(false));
        $args = array(
            'label' => $names_uc,
            'labels' => $labels,
            'hierarchical' => true,
         ...
         */
        \register_taxonomy($this->getTaxonomy(), [], $args);
    }
}
