...
trait SingleEndpointGraphiQLClientTrait
{
    ...
    protected function isGraphiQLExplorerOptionEnabled(): bool
    {
        ...
        return $userSettingsManager->getSetting(ClientFunctionalityModuleResolver::GRAPHIQL_EXPLORER, ClientFunctionalityModuleResolver::OPTION_USE_IN_PUBLIC_CLIENT_FOR_SINGLE_ENDPOINT);
    }
}
