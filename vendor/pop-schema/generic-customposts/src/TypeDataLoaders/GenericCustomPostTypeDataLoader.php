...
class GenericCustomPostTypeDataLoader extends AbstractCustomPostTypeDataLoader
{
    ...
    {
        return \array_merge(parent::getObjectQuery($ids), ['custompost-types' => ComponentConfiguration::getGenericCustomPostTypes()]);
    }
    public function getFilterDataloadingModule() : ?array
    {
        return [GenericCustomPostRelationalFieldDataloadModuleProcessor::class, GenericCustomPostRelationalFieldDataloadModuleProcessor::MODULE_DATALOAD_RELATIONALFIELDS_GENERICCUSTOMPOSTLIST];
    }
}
