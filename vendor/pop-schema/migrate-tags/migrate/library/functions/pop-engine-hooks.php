...
class Engine_Hooks
{
    ...
    public function augmentVarsProperties(array $vars_in_array) : void
    {
        ...
        $nature = $vars['nature'];
        $vars['routing-state']['is-tag'] = $nature == \PoPSchema\Tags\Routing\RouteNatures::TAG;
        // Save the name of the taxonomy as an attribute,
        // needed to match the RouteModuleProcessor vars conditions
        if ($nature == \PoPSchema\Tags\Routing\RouteNatures::TAG) {
 ...
 * Initialization
 */
new \PoPSchema\Tags\Engine_Hooks();
