...
abstract class SettingsProcessorBase
{
    public function __construct()
    {
        ...
        \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->addAction('popcms:init', array($this, 'init'), \PHP_INT_MAX);
    }
    public function init()
    {
        \PoP\ComponentModel\Settings\SettingsProcessorManagerFactory::getInstance()->add($this);
    }
    public abstract function routesToProcess();
