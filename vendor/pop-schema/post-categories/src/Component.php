...
class Component extends AbstractComponent
{
    ...
    {
        return [\PoPSchema\Posts\Component::class, \PoPSchema\Categories\Component::class];
    }
    /**
    ...
    {
        \PoPSchema\PostCategories\ComponentConfiguration::setConfiguration($configuration);
