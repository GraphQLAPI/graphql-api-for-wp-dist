...
abstract class AbstractInterfaceTypeResolver extends AbstractTypeResolver implements \PoP\ComponentModel\TypeResolvers\InterfaceType\InterfaceTypeResolverInterface
{
     ...
     *
     * @return string[]
     * @param \PoP\ComponentModel\FieldResolvers\InterfaceType\InterfaceTypeFieldResolverInterface $interfaceTypeFieldResolver
     */
    protected function getFieldNamesResolvedByInterfaceTypeFieldResolver($interfaceTypeFieldResolver) : array
    {
