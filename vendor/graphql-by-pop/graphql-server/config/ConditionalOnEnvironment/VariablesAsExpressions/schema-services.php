...
return function (\PrefixedByPoP\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $configurator) {
    ...
    $services->load('GraphQLByPoP\\GraphQLServer\\ConditionalOnEnvironment\\VariablesAsExpressions\\SchemaServices\\', '../../../src/ConditionalOnEnvironment/VariablesAsExpressions/SchemaServices/*');
};
