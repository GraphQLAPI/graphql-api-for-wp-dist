...
abstract class AbstractModuleProcessor implements ModuleProcessorInterface
{
    ...
    public function executeInitPropsModuletree($eval_self_fn, $get_props_for_descendant_modules_fn, $get_props_for_descendant_datasetmodules_fn, $propagate_fn, array $module, array &$props, $wildcard_props_to_propagate, $targetted_props_to_propagate)
    {
        ...
        $module_props[$moduleFullName][POP_PROPS_DESCENDANTATTRIBUTES] = array_merge($module_props[$moduleFullName][POP_PROPS_DESCENDANTATTRIBUTES] ?? array(), $targetted_props_to_propagate ?? array());
    ...
    public function initModelProps(array $module, array &$props)
    {
         ...
         */
        HooksAPIFacade::getInstance()->doAction(self::HOOK_INIT_MODEL_PROPS, array(&$props), $module, $this);
    }
    ...
    public function initRequestProps(array $module, array &$props)
    {
         ...
         * Allow to add more stuff
         */
        HooksAPIFacade::getInstance()->doAction(self::HOOK_INIT_REQUEST_PROPS, array(&$props), $module, $this);
    }
    ...
    public function getDatasetmoduletreeSectionFlattenedDataFields(array $module, array &$props): array
    {
        ...
        if (
            $data_fields = array_unique(array_merge($this->getDataFields($module, $props), array_keys($this->getDomainSwitchingSubmodules($module)), array_keys($this->getConditionalOnDataFieldSubmodules($module)), array_keys($this->getConditionalOnDataFieldDomainSwitchingSubmodules($module))))
        ) {
    ...
    protected function addHeaddatasetmoduleDataProperties(&$ret, array $module, array &$props)
    {
         ...
         * Allow to add more stuff
         */
        HooksAPIFacade::getInstance()->doAction(self::HOOK_ADD_HEADDATASETMODULE_DATAPROPERTIES, array(&$ret), $module, array(&$props), $this);
    }
    ...
    protected function maybeOverrideCheckpoints($checkpoints)
    {
        ...
        return HooksAPIFacade::getInstance()->applyFilters('ModuleProcessor:checkpoints', $checkpoints);
    }
    ...
    {
        return $this->getSubmodulesByGroup($module, array(
