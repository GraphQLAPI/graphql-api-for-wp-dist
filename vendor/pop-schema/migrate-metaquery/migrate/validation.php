...
class Validation
{
    ...
    {
        return \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->applyFilters('PoP_MetaQuery_Validation:provider-validation-class', null);
    }
    ...
    {
        $this->providerinstall_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'));
    }
    public function providerinitialize_warning()
    {
        $this->providerinitialize_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'));
    }
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-metaquery'));
    }
    public function installWarning()
    {
        $this->dependencyInstallationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-metaquery'), 'https://github.com/leoloso/PoP');
    }
    public function versionWarning()
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Meta Query', 'pop-metaquery'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-metaquery'), 'https://github.com/leoloso/PoP', POP_METAQUERY_POP_ENGINE_MIN_VERSION);
    }
