...
class Validation
{
    ...
    {
        return \PoP\Hooks\Facades\HooksAPIFacade::getInstance()->applyFilters('PoP_Comments_Validation:provider-validation-class', null);
    }
    ...
    {
        $this->providerinstall_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'));
    }
    public function providerinitialize_warning()
    {
        $this->providerinitialize_warning_notice(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'));
    }
    public function initializeWarning()
    {
        $this->dependencyInitializationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-comments'));
    }
    public function installWarning()
    {
        $this->dependencyInstallationWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-comments'), 'https://github.com/leoloso/PoP');
    }
    public function versionWarning()
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Comments', 'pop-comments'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Posts', 'pop-comments'), 'https://github.com/leoloso/PoP', POP_COMMENTS_POP_POSTS_MIN_VERSION);
    }
