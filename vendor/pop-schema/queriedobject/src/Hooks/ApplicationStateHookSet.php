...
{
    /**
     * @var \PoPSchema\QueriedObject\Routing\CMSRoutingStateServiceInterface
     */
    protected $cmsRoutingStateService;
    public function __construct(HooksAPIInterface $hooksAPI, TranslationAPIInterface $translationAPI, InstanceManagerInterface $instanceManager, CMSRoutingStateServiceInterface $cmsRoutingStateService)
    {
    ...
    {
        $this->hooksAPI->addAction('ApplicationState:addVars', [$this, 'setQueriedObject'], 0, 1);
        $this->hooksAPI->addAction(OperatorGlobalFieldResolver::HOOK_SAFEVARS, [$this, 'setSafeVars'], 10, 1);
    }
    /**
    ...
    public function setQueriedObject(array $vars_in_array) : void
    {
        ...
        list($queried_object, $queried_object_id) = $this->hooksAPI->applyFilters('ApplicationState:queried-object', [$this->cmsRoutingStateService->getQueriedObject(), $this->cmsRoutingStateService->getQueriedObjectId()]);
