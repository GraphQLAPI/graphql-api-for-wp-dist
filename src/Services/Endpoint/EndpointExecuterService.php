...
class EndpointExecuterService extends AbstractAutomaticallyInstantiatedService
{
    ...
    /**
     * @var \GraphQLAPI\GraphQLAPI\Registries\EndpointExecuterRegistryInterface|null
     */
    private $customEndpointExecuterRegistry;

    /**
     * @param \GraphQLAPI\GraphQLAPI\Registries\EndpointExecuterRegistryInterface $customEndpointExecuterRegistry
     */
    final public function setEndpointExecuterRegistry($customEndpointExecuterRegistry): void
    {
    ...
    final protected function getEndpointExecuterRegistry(): EndpointExecuterRegistryInterface
    {
        ...
        return $this->customEndpointExecuterRegistry = $this->customEndpointExecuterRegistry ?? $this->instanceManager->getInstance(EndpointExecuterRegistryInterface::class);
    }
