...
abstract class AbstractDocument extends UpstreamDocument
{
     ...
     */
    protected function isVariableDefined($variableReference) : bool
    {
     ...
     */
    protected function getVariableReferencesInDirectives($directives) : array
    {
     ...
     */
    protected function assertArgumentsUniqueInDirectives($directives) : void
    {
     ...
     */
    protected function setAncestorsUnderDirective($astNodeAncestors, $directive) : void
    {
    ...
    /**
     * @return Argument[]
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function getDynamicVariableDefinitionArgumentsInOperation($operation) : array
    {
    ...
    /**
     * @return Argument[]
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Fragment $fragment
     */
    protected function getDynamicVariableDefinitionArgumentsInFragment($fragment) : array
    {
     ...
     * @return Argument[]
     */
    protected function getDynamicVariableDefinitionArgumentsInFieldsOrInlineFragments($fieldsOrFragmentBonds) : array
    {
        $dynamicVariableDefinitionArguments = [];
     ...
     * @return Argument[]
     */
    protected function getDynamicVariableDefinitionArgumentsInDirectives($directives) : array
    {
        $dynamicVariableDefinitionArguments = [];
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function assertNonSharedVariableAndResolvedFieldValueReferenceNamesInOperation($operation) : void
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function getObjectResolvedFieldValueReferencesInOperation($operation) : array
    {
     ...
     * @return ObjectResolvedFieldValueReference[]
     */
    protected function getObjectResolvedFieldValueReferencesInFieldsOrInlineFragments($fieldsOrFragmentBonds) : array
    {
     ...
     * @return ObjectResolvedFieldValueReference[]
     */
    protected function getObjectResolvedFieldValueReferencesInArguments($arguments) : array
    {
        $objectResolvedFieldValueReferences = [];
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Fragment $fragment
     */
    protected function getObjectResolvedFieldValueReferencesInFragment($fragment) : array
    {
     ...
     */
    protected function getDependedUponOperationNamesInArgument($argument) : array
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function getOperationDependencyDefinitionArgumentsInOperation($operation) : array
    {
     ...
     * @return Argument[]
     */
    protected function getOperationDependencyDefinitionArgumentsInDirectives($directives) : array
    {
        $operationDependencyDefinitionArguments = [];
        foreach ($directives as $directive) {
            /**
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Directive $directive
     */
    protected abstract function isOperationDependencyDefinerDirective($directive) : bool;
    /**
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Directive $directive
     */
    protected abstract function getProvideDependedUponOperationNamesArgument($directive) : ?Argument;
    /**
     * @throws InvalidRequestException
     */
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function assertOperationDoesNotFormLoop($operation) : void
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\OperationInterface $operation
     */
    protected function getDependedUponOperations($operation) : array
    {
        $dependedUponOperations = [];
        $operationDependencyDefinitionArguments = $this->getOperationDependencyDefinitionArgumentsInOperation($operation);
        foreach ($operationDependencyDefinitionArguments as $operationDependencyDefinitionArgument) {
            $item1Unpacked = $this->getDependedUponOperationsInArgument($operationDependencyDefinitionArgument);
            $dependedUponOperations = \array_merge($dependedUponOperations, $item1Unpacked);
        }
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\Argument $argument
     */
    protected function getDependedUponOperationsInArgument($argument) : array
    {
     ...
     * @param string $name
     */
    public function getOperation($name) : ?OperationInterface
    {
        foreach ($this->getOperations() as $operation) {
