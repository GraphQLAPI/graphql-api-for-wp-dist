...
trait TypeSchemaDefinitionResolverTrait
{
     ...
     * @param int $typeModifiers
     * @param string|null $deprecationMessage
     */
    public final function getTypeSchemaDefinition($name, $typeResolver, $description, $defaultValue, $typeModifiers, $deprecationMessage = null) : array
    {
