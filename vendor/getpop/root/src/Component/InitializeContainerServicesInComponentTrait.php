...
trait InitializeContainerServicesInComponentTrait
{
     ...
     */
    public static function initServices(string $componentDir, string $configPath = '', string $fileName = 'services.yaml') : void
    {
     ...
     * If not provided, use "services.yaml"
     */
    protected static function loadServicesFromYAMLConfigIntoContainer(ContainerBuilder $containerBuilder, string $componentDir, string $configPath, string $fileName) : void
    {
     ...
     */
    public static function initSchemaServices(string $componentDir, bool $skipSchema, string $configPath = '', string $fileName = 'schema-services.yaml') : void
    {
        if (!ContainerBuilderFactory::isCached()) {
            /** @var ContainerBuilder */
            $containerBuilder = ContainerBuilderFactory::getInstance();
            ...
            $loader = new ForceAutoconfigureYamlFileLoader($containerBuilder, new FileLocator($componentPath), $autoconfigure);
            $loader->load($fileName);
        }
    }
    /**
     ...
     */
    public static function initSystemServices(string $componentDir, string $configPath = '', string $fileName = 'system-services.yaml') : void
    {
        // First check if the container has been cached. If so, do nothing
