    ...
    public function getSettings(string $module): array
    {
        ...
        if ($module == self::SCHEMA_CONFIGURATION) {
            ...
            $moduleSettings[] = [
                ...
                Properties::DESCRIPTION => sprintf(\__('Schema Configuration to use when option <code>"Default"</code> is selected (in %s)', 'graphql-api'), implode(\__(', ', 'graphql-api'), $whereModules)),
            ...
            $whereModuleNames = array_map(function ($whereModule) use ($moduleRegistry) {
            ...
            $moduleSettings[] = [
                ...
                Properties::DESCRIPTION => sprintf(\__('Visibility to use for fields and directives in the schema when option <code>"%s"</code> is selected (in %s)', 'graphql-api'), ComponentConfiguration::getSettingsValueLabel(), implode(\__(', ', 'graphql-api'), $whereModuleNames)),
