...
trait FilterIDsSatisfyingConditionFieldDirectiveResolverTrait
{
     ...
     */
    protected function getIDsSatisfyingCondition($relationalTypeResolver, $idObjects, $idFieldSet, &$succeedingPipelineIDFieldSet, &$resolvedIDFieldValues, &$messages, $engineIterationFeedbackStore) : array
    {
     ...
     * @param array<array<string|int,EngineIterationFieldSet>> $succeedingPipelineIDFieldSet
     */
    protected function removeFieldSetForIDs($idFieldSet, $idsToRemove, &$succeedingPipelineIDFieldSet) : void
    {
