...
class FilterInnerModuleProcessor extends AbstractModuleProcessor
{
    ...
    public function getSubmodules(array $module) : array
    {
        ...
        $inputmodules = [self::MODULE_FILTERINNER_POSTS => $postListModules, self::MODULE_FILTERINNER_POSTCOUNT => $postCountModules, self::MODULE_FILTERINNER_ADMINPOSTS => \array_merge($postListModules, [$statusModule]), self::MODULE_FILTERINNER_ADMINPOSTCOUNT => \array_merge($postCountModules, [$statusModule])];
        if ($modules = $this->hooksAPI->applyFilters('Posts:FilterInnerModuleProcessor:inputmodules', $inputmodules[$module[1]], $module)) {
