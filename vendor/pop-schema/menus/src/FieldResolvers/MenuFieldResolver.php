...
class MenuFieldResolver extends AbstractDBDataFieldResolver
{
    ...
    public function getSchemaFieldArgs(TypeResolverInterface $typeResolver, string $fieldName) : array
    {
        switch ($fieldName) {
            case 'itemDataEntries':
                return [[SchemaDefinition::ARGNAME_NAME => 'flat', SchemaDefinition::ARGNAME_TYPE => SchemaDefinition::TYPE_BOOL, SchemaDefinition::ARGNAME_DESCRIPTION => $this->translationAPI->__('Flatten the items', 'menus')]];
        }
        return parent::getSchemaFieldArgs($typeResolver, $fieldName);
    }
    public function getSchemaFieldDescription(TypeResolverInterface $typeResolver, string $fieldName) : ?string
    {
        $descriptions = ['itemDataEntries' => $this->translationAPI->__('The menu items', 'menus')];
