...
if (!\function_exists('normalizer_is_normalized')) {
    function normalizer_is_normalized($string, $form = \PrefixedByPoP\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
        return \PrefixedByPoP\Symfony\Polyfill\Intl\Normalizer\Normalizer::isNormalized($string, $form);
    }
}
if (!\function_exists('normalizer_normalize')) {
    function normalizer_normalize($string, $form = \PrefixedByPoP\Symfony\Polyfill\Intl\Normalizer\Normalizer::FORM_C)
    {
