...
abstract class AbstractObjectTypeResolver extends AbstractRelationalTypeResolver implements \PoP\ComponentModel\TypeResolvers\ObjectType\ObjectTypeResolverInterface
{
     ...
     */
    public final function enqueueFillingObjectsFromIDs($idFieldSet) : void
    {
     ...
     */
    public final function getFieldSchemaDefinition($field) : ?array
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    public final function getFieldTypeResolver($field) : ?ConcreteTypeResolverInterface
    {
        $executableObjectTypeFieldResolver = $this->getExecutableObjectTypeFieldResolverForField($field);
        if ($executableObjectTypeFieldResolver === null) {
            return null;
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    public final function getFieldTypeModifiers($field) : ?int
    {
        $executableObjectTypeFieldResolver = $this->getExecutableObjectTypeFieldResolverForField($field);
        if ($executableObjectTypeFieldResolver === null) {
            return null;
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    public final function getFieldMutationResolver($field) : ?MutationResolverInterface
    {
        $executableObjectTypeFieldResolver = $this->getExecutableObjectTypeFieldResolverForField($field);
        if ($executableObjectTypeFieldResolver === null) {
            return null;
     ...
     */
    public final function resolveValue($object, $fieldOrFieldDataAccessor, $objectTypeFieldResolutionFeedbackStore)
    {
     ...
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function maybeGetFieldDataAccessorForObject($fieldDataAccessor, $id, $objectTypeFieldResolutionFeedbackStore) : ?FieldDataAccessorInterface
    {
        $field = $fieldDataAccessor->getField();
        ...
        try {
            ...
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback($valueResolutionPromiseException->getFeedbackItemResolution(), $valueResolutionPromiseException->getAstNode()));
        }
     ...
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function validateFieldArgsForObject($fieldDataAccessor, $objectTypeFieldResolver, $object, $objectTypeFieldResolutionFeedbackStore) : void
    {
        $fieldArgs = null;
        try {
            $fieldArgs = $fieldDataAccessor->getFieldArgs();
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    protected final function getFieldArgumentsSchemaDefinition($field) : ?array
    {
     ...
     * @param bool $global
     */
    public final function getExecutableObjectTypeFieldResolversByField($global) : array
    {
     ...
     * @param bool $global
     */
    public final function getObjectTypeFieldResolversByField($global) : array
    {
        $cacheKey = $global ? 'global' : 'non-global';
     ...
     * @param \PoP\ComponentModel\FieldResolvers\ObjectType\ObjectTypeFieldResolverInterface $objectTypeFieldResolver
     */
    protected final function getFieldNamesResolvedByObjectTypeFieldResolver($objectTypeFieldResolver) : array
    {
     ...
     * @return InterfaceTypeFieldResolverInterface[]
     */
    protected function consolidateAllImplementedInterfaceTypeFieldResolvers($interfaceTypeFieldResolvers) : array
    {
     ...
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     */
    public final function hasObjectTypeFieldResolversForField($field) : bool
    {
     ...
     */
    protected function doGetObjectTypeResolverObjectFieldData($field, $ids, $idObjects, $engineIterationFeedbackStore) : ?SplObjectStorage
    {
        $executableObjectTypeFieldResolver = $this->getExecutableObjectTypeFieldResolverForField($field);
        if ($executableObjectTypeFieldResolver === null) {
            /**
     ...
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function getFieldArgs($field, $objectTypeFieldResolutionFeedbackStore) : ?array
    {
     ...
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function doGetFieldArgs($field, $objectTypeFieldResolutionFeedbackStore) : ?array
    {
     ...
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function validateInvariableOnObjectResolutionFieldData($fieldArgs, $field, $objectTypeFieldResolutionFeedbackStore) : void
    {
        /** @var array<string,mixed> */
        $fieldArgsSchemaDefinition = $this->getFieldArgumentsSchemaDefinition($field);
        /** @var ObjectTypeFieldResolverInterface */
     ...
     * @param array<string,mixed> $fieldArgs
     * @param \PoP\GraphQLParser\Spec\Parser\Ast\FieldInterface $field
     * @param bool $validateMutation
     * @param \PoP\ComponentModel\Feedback\ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore
     */
    protected function validateVariableOnObjectResolutionFieldData($fieldArgs, $field, $validateMutation, $objectTypeFieldResolutionFeedbackStore) : void
    {
        /** @var array<string,mixed> */
        $fieldArgsSchemaDefinition = $this->getFieldArgumentsSchemaDefinition($field);
        /**
     ...
     * @param \PoP\ComponentModel\QueryResolution\FieldDataAccessorInterface $fieldDataAccessor
     */
    protected function getValidationCheckpoints($objectTypeFieldResolver, $fieldDataAccessor) : array
    {
    ...
    private function validateNonMissingOrNullMandatoryFieldArguments(array $fieldArgs, array $fieldArgsSchemaDefinition, FieldInterface $field, ObjectTypeFieldResolutionFeedbackStore $objectTypeFieldResolutionFeedbackStore) : void
    {
        ...
        foreach ($nullNonNullableFieldArgNames as $nullNonNullableFieldArgName) {
            $objectTypeFieldResolutionFeedbackStore->addError(new ObjectTypeFieldResolutionFeedback(new FeedbackItemResolution(GraphQLSpecErrorFeedbackItemProvider::class, GraphQLSpecErrorFeedbackItemProvider::E_5_4_2_1_B, [$nullNonNullableFieldArgName, $field->getName(), $this->getMaybeNamespacedTypeName()]), (($getArgument = $field->getArgument($nullNonNullableFieldArgName)) ? $getArgument->getValueAST() : null) ?? $field->getArgument($nullNonNullableFieldArgName) ?? $field));
        }
    }
    /**
