...
class ModelInstanceHookSet extends AbstractHookSet
{
    ...
    public function getModelInstanceComponentsFromVars($components)
    {
        ...
        if ($nature == RouteNatures::CUSTOMPOST && $vars['routing-state']['queried-object-post-type'] == $postTypeAPI->getPostCustomPostType()) {
            ...
            if ($this->hooksAPI->applyFilters(self::HOOK_VARY_MODEL_INSTANCE_BY_CATEGORY, \false)) {
