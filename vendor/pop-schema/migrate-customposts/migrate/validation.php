...
class Validation
{
    ...
    {
        $this->dependencyVersionWarning(\PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Post Media', 'pop-postmedia'), \PoP\Translation\Facades\TranslationAPIFacade::getInstance()->__('PoP Engine', 'pop-postmedia'), 'https://github.com/leoloso/PoP', POP_CUSTOMPOSTS_POP_ENGINE_MIN_VERSION);
    }
