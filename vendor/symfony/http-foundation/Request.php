...
class Request
{
     ...
     */
    public static function normalizeQueryString($qs) : string
    {
        if ('' === ($qs ?? '')) {
            return '';
        }
     ...
     * @param string $path
     */
    public function getRelativeUriForPath($path) : string
    {
     ...
     * @param string $format
     */
    public function getMimeType($format) : ?string
    {
     ...
     */
    public function getPreferredLanguage($locales = null) : ?string
    {
