...
class SchemaCastingService implements \PoP\ComponentModel\Schema\SchemaCastingServiceInterface
{
    ...
    protected final function getInputCoercingService() : \PoP\ComponentModel\Schema\InputCoercingServiceInterface
    {
        ...
        return $this->inputCoercingService = $this->inputCoercingService ?? $this->instanceManager->getInstance(\PoP\ComponentModel\Schema\InputCoercingServiceInterface::class);
    }
    /**
    ...
    public function castArguments($argumentKeyValues, $argumentSchemaDefinition, $withArgumentsAST, $objectTypeFieldResolutionFeedbackStore) : array
    {
        ...
        foreach ($argumentKeyValues as $argName => $argValue) {
            ...
            if ($isDangerouslyNonSpecificScalar) {
                 ...
                 */
                $argValue = $inputCoercingService->maybeConvertInputValueFromSingleToList($argValue, $fieldOrDirectiveArgIsArrayType, $fieldOrDirectiveArgIsArrayOfArraysType);
            }
            ...
            $inputCoercingService->validateInputArrayModifiers($fieldOrDirectiveArgTypeResolver, $argValue, $argName, $fieldOrDirectiveArgIsArrayType, $fieldOrDirectiveArgIsNonNullArrayItemsType, $fieldOrDirectiveArgIsArrayOfArraysType, $fieldOrDirectiveArgIsNonNullArrayOfArraysItemsType, $astNode, $objectTypeFieldResolutionFeedbackStore);
