...
class RequestUtils
{
    ...
    public static function getCurrentUrl()
    {
        ...
        $remove_params = (array) HooksAPIFacade::getInstance()->applyFilters('RequestUtils:current_url:remove_params', array(
    ...
    {
        return HooksAPIFacade::getInstance()->applyFilters('RequestUtils:getFramecomponentModules', array());
    }
